 ...
 * @author John Legg
 */
public class Moreproblemfour extends javax.swing.JFrame {

    public Moreproblemfour() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("More Problems Fourth Grade");//text
        ...
        geometry.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/moreproblemsgeo3.png")));//icon for button
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.education.com/worksheets/fourth-grade/geometry/"; // open and another kids math app.
        ...
        baseten.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/4thgradebaseten.png")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.khanacademy.org/commoncore/grade-4-NBT"; // open and another kids math app.
                    Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.khanacademy.org/commoncore/grade-4-OA"; // open and another kids math app.
                    Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Moreproblemfour().setVisible(true);
            }
        });
    }
