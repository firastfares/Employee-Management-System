 ...
 * @author John Legg
 */
public class Moreproblemk extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title.setText("More Problems Kindergarten");//text
        ...
        geometry.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/kidergeometry.png")));//icon for button
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.education.com/games/kindergarten/2d-shapes/"; // open and another kids math app.
        ...
        baseten.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/kiderbaseten.png")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.khanacademy.org/math/cc-kindergarten-math/cc-kindergarten-counting#kindergarten-counting"; // open and another kids math app.
                    Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        algebraic.setText("Adding and Subtracting");//text
        ...
        algebraic.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/kideralgebraic2.png")));//button icon
        ...
        algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.khanacademy.org/math/cc-kindergarten-math/cc-kindergarten-add-subtract"; // open and another kids math app.
                    Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Moreproblemk().setVisible(true);
            }
        });
    }
