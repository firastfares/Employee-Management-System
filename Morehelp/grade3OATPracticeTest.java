...
public class grade3OATPracticeTest extends JFrame {

	/**
	 * Creates new form grade3OATPracticeTest
	 */
	...
	private int clicked = 0; //variable I was using to test tracking button clicks which we'll use to implement the auto hint feature. Ignore for now.
	...
	//cluster method where all our buttons, labels, and other shit gets initiated. should probably try to clean this up at some point
	private void initComponents() {
		...
		classbut.setBounds(0, 340, 227, 51);
		unitbut = new JButton();
		...
		header.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					grade3OATPracticeTest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
			label.setFont(font.deriveFont(Font.BOLD, 35f));
		} catch (Exception e) {
		}
		getContentPane().setLayout(null);
		hintButton.setBounds(781, 54, 189, 182);
		
		
		hintButton.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/Webp.net-resizeimage (18).png")));
		hintButton2.setBounds(781, 54, 189, 182);
		
		hintButton2.setContentAreaFilled(false);
		hintButton2.setBorderPainted(false);
		
		getContentPane().add(hintButton2);
		hintButton3.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/Webp.net-resizeimage (18).png")));
		hintButton3.setBounds(781, 54, 189, 182);
		...
		hintButton4.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/Webp.net-resizeimage (18).png")));
		hintButton4.setBounds(781, 54, 189, 182);
		...
		hintButton5.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/Webp.net-resizeimage (18).png")));
		hintButton5.setBounds(781, 54, 189, 182);
		...
		headerTitle.setText("Grade 3 O/A Practice Test");
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, grade3OATPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
	       }
		catch(Exception e){}
		...
		try{
			 Font font = Font.createFont(Font.TRUETYPE_FONT, grade3OATPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
				question1.setBounds(100, 67, 136, 27);
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, grade3OATPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
	           textArea5.setFont(font.deriveFont(Font.BOLD, 15f));
	       }
		catch(Exception e){}
		...
		correctAnswer.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/incorrectX.png")));
		incorrectAnswer.setVisible(false);
		incorrectAnswer.setBounds(472, 135, 100, 106);
		panel.add(incorrectAnswer);
		
		xxx.setBounds(472, 150, 100, 106);
		panel.add(xxx);
		xxx.setVisible(false);

		
		buttonA.setPressedIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("/phase3/Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonF.setIcon(new ImageIcon(grade3OATPracticeTest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
	         ...
	         int y = randomFill(3, 5); //These last two variables are specifically for one type of addition problems that requires the two numbers to be less than 10, but with a sum greater than 10
	         
	         //My attempt at making the word problem premise sort of random. You can delete these for numbers and operations in base 10.
	         String[] wordProblems = {"Jason is making sandwiches. "
	         		+ " If he has ", "Janet is baking cupcakes. If she has ", "Janet is making sandwiches. If she has ", "Jason is baking cupcakes. If he has "};
	         
	         Collections.shuffle(Arrays.asList(wordProblems));
	 
		      
			          //Question array. i, j, and k are substituted for real numbers. While the values of i, j, and k will be randomized each time the test is run, those numbers will not be randomized again at any point during the test.
	         		  ...
	         		  //Question order is multiplication, addition, division (this question is currently set to i*2/2 to ensure that i is always even and that the answer is never a decimal), subtraction, and a triangle area question.
			      	String[] questions = 	{wordProblems[0] + i + " friends coming over and made " + j + " for each of them, how many were made?", 
			      	...
			      	String[] hints = {"This can be solved by multiplication because for each of the " + i + " friends, there will be " + j + " baked goods!", 
			      			"Try to think of the problem as removing " + k + " sticks from a pile of " + (j+1) + " sticks!", "What is the relationship between multiplication and divsion?", "Each sum which is larger than 10 can be found by first making a 10! For example, to find 8 + 5, we can write\r\n" + 
			      					"8 + 5 = 8 + (2 + 3) = ( 8 + 2) + 3 = 10 + 3 = 13.", "Does order matter in multiplication?"};
			      	 
			      //This if statements is used to sort out random number awkwardness for the subtraction problem.
			    
			      	//Same thing for subtraction. If (k+1) is less than j, the placements of those numbers will be reversed to prevent a negative answer, and all three arrays will be updated. 
			      	if ((j+1) < k) 
			      	{
			      		questions[1] = "Subtract: " + k + " - " + (j+1);
			      		answer[1] = (""+(k - (j+1)));
			      		hints[1] = "Try to think of the problem as removing " + (j+1) + " sticks from a pile of " + k + " sticks!";
			      		
			      	}
			      	
			      	
			      	//This if statement is used for the last problem, which covers multiplication order. Makes sure that the two numbers aren't the same and updates the questions array.
			      	if ((i*2) == j*2)
			      	{
			      		questions[4] = "Should " + ((j*2)+1) + " x " + (i*2) + " give the same answer as " + ((i*2)+1) + " x " + (j*2) + " ? Enter yes or no.";
		...
		beginTest.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent evt) {
				...
				hintButton.addMouseListener(new MouseAdapter() {
					public void mousePressed(MouseEvent evt) { //If the user clicks the question mark button, the hint will display
		...
		beginTest.addMouseListener(new MouseAdapter() {
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, "The answer is " + (i*j) + " because for each of the " + i + " friends, there will be " + j + " baked goods!"); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want./
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
								buttonA.setVisible(true);//The first arrow button gets made visible
								correctInWords.setVisible(true);
								correctInWords.setText("INCORRECT!");
								textAnswer.setDisabledTextColor(new Color(255, 0, 0)); //If the auto hint triggers, the question is marked incorrect. Therefore correct_guess is not incremented and the text color of the disabled text field is set to red.
			...
			//This mouse listener, along with all subsequent arrow buttons (buttons A-D + F), does exactly what the beginTest mouse listener did. 
			...
			buttonA.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					try{
				           Font font = Font.createFont(Font.TRUETYPE_FONT, grade3OATPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
				           textArea5.setFont(font.deriveFont(Font.BOLD, 25f)); //adjusting the font size to make it bigger
				       }
					catch(Exception e){}
					...
					hintButton.setVisible(false); //making the first hint buttonm invisible and making the 2nd hint button visible
				...
				public void mousePressed(MouseEvent evt) {
					...
					try{
			      		...
			      		else
						{
							...
							{
			      			clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[1] + ". Next time, try to think of the problem as removing sticks from the larger pile of sticks!");
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
			      		...
			      		if (userAnswer.equals(answer[2]) || userAnswer.equals(" " + answer[2])) {
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[2] + ". Next time, try to remember that divsion is simply the inverse of multiplication! If " + i + " x " + 2 + " = " + i*2 + ", then " + i*2 + "/" + 2 +  " = " + i + "!" );
			...
			buttonC.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					try{
				           Font font = Font.createFont(Font.TRUETYPE_FONT, grade3OATPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
				           textArea5.setFont(font.deriveFont(Font.BOLD, 18f));
			...
			submitAnswer4.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[3] + ". Next time, try to remember these steps to using the making a 10 method:\r\n " +
									"Step 1: Pick one of the two numbers. The first addend and what make ten?\r\n" + 
				...
				public void mousePressed(MouseEvent evt) {
					try{
						...
						if (clicked == 3)
						{
							...
							JOptionPane.showMessageDialog(panel, "The answer is yes! Order does not matter with multiplication!");
							submitAnswer5.setVisible(false);
							buttonF.setVisible(true);
			...
			buttonF.addMouseListener(new MouseAdapter() {
				...
				//beginning of the results display section. You shouldn't have to edit any of this at all and can keep it as is for all tests.
					resultsBut.addMouseListener(new MouseAdapter() {
						public void mousePressed(MouseEvent evt) {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(grade3OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new grade3OATPracticeTest().setVisible(true);
			}
		});
	}
