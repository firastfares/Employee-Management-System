 ...
 * @author John Legg
 */
public class gradefourbasetenrecselect extends javax.swing.JFrame {


    public gradefourbasetenrecselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Recordings On Fourth Grade Number and Operation Base Ten");//text of label
        ...
        multidigitpv.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=nxbW4GGdn9I"; // open this video on multidigit place value
        ...
        addsubmultidigit.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=Rt8ExTLwJo0"; // open this video on add and sub whole  multi-digit numbers
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        multiply.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=PZjIT9CH6bM"; // open this video on multiplying two  two digit numbers
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradefourbasetenrecselect().setVisible(true);
            }
        });
    }
