 ...
 * @author John Legg
 */
public class gradeonegeometryvidselect extends javax.swing.JFrame {


    public gradeonegeometryvidselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Videos On First Grade Geometry");//text
        ...
        shapeattribute.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video when pressed
                try {
                    String url = "https://www.youtube.com/watch?v=NmaKlT2Zrfk"; // open this video on shape attributes
        ...
        shapepartition.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video when pressed
                try {
                    String url = "https://www.youtube.com/watch?v=NFJLxia1kGE"; // open this video shape partitioning
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradeonegeometryvidselect().setVisible(true);
            }
        });
    }
