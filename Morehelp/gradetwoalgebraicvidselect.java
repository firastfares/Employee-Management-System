 ...
 * @author John Legg
 */
public class gradetwoalgebraicvidselect extends javax.swing.JFrame {


    public gradetwoalgebraicvidselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Videos On Second Grade Operations and Algebraic Thinking");//text of label
        ...
        addsubtract.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=CqBiAcH0CJM"; // open this video on addition and subtraction within 20 no objects mental strats
        ...
        totalinarry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=yKQAFP8ANP0"; // open this video on addition of total number of object in a array
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        wordproblems.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=zQGksxr1ZmI"; // open this video on word problems of add and subtract within 100
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradetwoalgebraicvidselect().setVisible(true);
            }
        });
    }
