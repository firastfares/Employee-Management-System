 ...
 * @author John Legg
 */
public class gradetwobasetenrecselect extends javax.swing.JFrame {


    public gradetwobasetenrecselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Recordings On Grade Two Number and Operation Base Ten");//text of label
        ...
        threedigit.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=XhJVqYbjhSY"; // open this video on understanding three digit numbers
        ...
        addsub10or100.setText("Add or Subtract 10 or 100");//text
        ...
        addsub10or100.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=ZJ39gHgz_Dk"; // open this video on Add or Subtract 10 or 100
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        addsub100.setText("Add or Subtract within 100");//button text
        ...
        addsub100.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=c5xLHlAvYI0"; // open this video on add or sub within 100
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradetwobasetenrecselect().setVisible(true);
            }
        });
    }
