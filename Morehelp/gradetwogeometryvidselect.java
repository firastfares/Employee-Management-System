 ...
 * @author John Legg
 */
public class gradetwogeometryvidselect extends javax.swing.JFrame {


    public gradetwogeometryvidselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Videos On Second Grade Geometry");//text
        ...
        shapeface.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video when button is clicked
                try {
                    String url = "https://www.youtube.com/watch?v=VQBQZ_jvpZA"; // open this video on recognizing a shape by number of faces
        ...
        rowandcolumns.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video on browser
                try {
                    String url = "https://www.youtube.com/watch?v=00m3YhLT6fA"; // open this video on row and columns
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradetwogeometryvidselect().setVisible(true);
