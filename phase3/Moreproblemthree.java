 ...
 * @author John Legg
 */
public class Moreproblemthree extends javax.swing.JFrame {

    public Moreproblemthree() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("More Problems Third Grade");//text
        ...
        geometry.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/moreproblemsgeo2.png")));//icon for button
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.education.com/resources/third-grade/geometry/"; // open and another kids math app.
        ...
        baseten.setText("Base Ten Operations");//text
        ...
        baseten.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/moreproblemsbaseten2.png")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.khanacademy.org/commoncore/grade-3-NBT"; // open and another kids math app.
                    Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        algebraic.setText("Algebraic Operations");//text
        ...
        algebraic.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/moreproblemsalgebraic.png")));//button icon
        ...
        algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.khanacademy.org/math/cc-third-grade-math/intro-to-multiplication"; // open and another kids math app.
                    Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Moreproblemthree().setVisible(true);
            }
        });
    }
