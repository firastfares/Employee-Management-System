...
public class grade1OATPracticeTest extends JFrame {

	/**
	 * Creates new form grade1OATPracticeTest
	 */
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 734);
		sidebar.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					grade1OATPracticeTest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		hintButton.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton3.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton4.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton5.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		headerTitle.setText("Grade 1 O/A Practice Test");
		...
		try{
			 Font font = Font.createFont(Font.TRUETYPE_FONT, grade1OATPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
		...
		correctAnswer.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(grade1OATPracticeTest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
	         ...
	         int i = randomFill(1, 5);
	         int j = randomFill(10, 30);
	         int k = randomFill(6, 10);
	         int x = randomFill(6, 10);
	         int y = randomFill(3, 7);
			      	...
			      	String[] questions = 	{"There were " + x + " people at the park. Then " + y + " showed up. How many people were at the park altogether?", 
			      			"There were " + (x+3) + " people at the park. Then some more showed up. There were " + ((x+3)+(y+2)) + " people in all. How many people came?",
			      			"Dave said that " + k + " + " + k + " should be " + (k+k) + ". Is he correct? Enter yes or no.", 
			      					
			      			(x+1) + " kites were flying in the sky. Some kites crashed in a tree. There were " + (y-1) + " kites left in the sky. How many are in the tree?", "Fill in the blank: " + (k+5) + " - " + "_____" + " = " + ((k+5)-(i))};
			      	...
			      	String[] answer = {""+(x+y), ""+(((x+3)+(y+2) - (x+3))), "yes", "" + ((x+1)-(y-1)), "" + i};
			      	...
			      	String[] hints = {"What do you need to do to find the unknown value?", 
			      			"Use subtraction for this problem! " , "Try to recall strategies you've learned about adding doubles!", "Use subtraction to figure out the unknown value!", "Try manipulating the two numbers given in some way to figure out the unknown value!"};
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, "The answer is " + answer[0] + "! You needed to add " + x + " and " + y + " to determine the total number of people at the park!"); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
				...
				public void mousePressed(MouseEvent evt) {
					...
					try{
			      		...
			      		else
						{
							...
							{
			      			clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[1] +  "! You needed to subtract the number of current people at the park from the number of total people at the park to find how many new people showed up!");
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[2] + "! Dave wouldn't lie to you.");
							submitAnswer3.setVisible(false);
							buttonC.setVisible(true);
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new MouseAdapter() {
						public void mousePressed(MouseEvent evt) {
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,1g2practice) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 1g2practice =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(grade1OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(grade1OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(grade1OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new grade1OATPracticeTest().setVisible(true);
			}
		});
	}
