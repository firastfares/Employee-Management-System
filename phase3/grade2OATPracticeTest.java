...
public class grade2OATPracticeTest extends JFrame {

	/**
	 * Creates new form grade2OATPracticeTest
	 */
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 734);
		sidebar.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					grade2OATPracticeTest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		hintButton.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton3.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton4.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton5.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		headerTitle.setText("Grade 2 O/A Practice Test");
		...
		try{
			 Font font = Font.createFont(Font.TRUETYPE_FONT, grade2OATPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
		...
		correctAnswer.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(grade2OATPracticeTest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
	         ...
	         int i = randomFill(40, 50);
	         int j = randomFill(10, 30);
	         int k = randomFill(15, 30);
	         int x = randomFill(1, 5);
	         int y = randomFill(1, 5);
			      	...
			      	String[] questions = 	{"A pencil costs " + i + " cents, and a sticker costs " + j + " cents less than that. How much do a pencil and a sticker cost together?", 
			      			"Hendrick wants to give " + "$" + k + " to help kids who need school supplies. He also wants to buy shoes for " + "$" + (j+3) + ". How much money will he need for both?",  
			      			"Hendrick  gets " + "$" + x + " for his allowance each week. How many weeks of saving would it take him to reach his goal of " + "$" + (k+(j+3)) + "?" , "Solve: " + x + " + " + y,"Should " + (x + 4) + " + " + (k+5) + " give same result if the " + (x+4) + " and the " + (k+5) + " were reversed?"};
			      	...
			      	String[] answer = {""+((i-j)+i), ""+(k+(j+3)), "" + ((k+(j+3))/x), "" + (x+y), "yes"};
			      	...
			      	String[] hints = {"This problem requires both subtraction and addition!", 
			      			"Try to recall the strategies you learned for adding double digit numbers! " , "Remember, each time a week goes by, Hendrick gets " + "$" + x + ". Try adding that number to itself until you get " + "$" + (k+(j+3)) + ", and count how many times you did it!", "Try to recall addition strategies!", "Does order matter for addition?"};
		...
		beginTest.addMouseListener(new MouseAdapter() {
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, "The answer is " + answer[0] + ". Subtract " + j + " from " + i + " first to find out how much the sticker costs, and then add that number to the cost of the pencil to calculate the total price!"); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
			...
			buttonA.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					textArea5.setFont(new Font("Calibri", Font.BOLD, 13));
				...
				public void mousePressed(MouseEvent evt) {
					...
					try{
			      		...
			      		else
						{
							...
							{
			      			clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[1] +  " Try to recall the strategies you learned for adding double digit numbers! ");
			...
			buttonB.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					textArea5.setFont(new Font("Calibri", Font.BOLD, 15));
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[2] + "! Every week, Hendrick gets " + "$" + x + ". Adding that number to itself until you get " + "$" + (k+(j+3)) + ", and \r\n counting how many times it was added in total produces the answer" );
			...
			buttonC.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					textArea5.setFont(new Font("Calibri", Font.BOLD, 30));
			...
			submitAnswer4.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[3] + " " + hints[3]);
							submitAnswer4.setVisible(false);
				...
				public void mousePressed(MouseEvent evt) {
					try{
						...
						if (clicked == 3)
						{
							...
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[4] + "! Order does not matter for additon!");
							submitAnswer5.setVisible(false);
							buttonF.setVisible(true);
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new MouseAdapter() {
						public void mousePressed(MouseEvent evt) {
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,2g2practice) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 2g2practice =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(grade2OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(grade2OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(grade2OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new grade2OATPracticeTest().setVisible(true);
			}
		});
	}
