...
public class grade2OATUnitTestEasy extends JFrame {

	/**
	 * Creates new form grade2OATUnitTestEasy
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 734);
		sidebar.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					grade2OATUnitTestEasy.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		headerTitle.setText("Grade 2 O/A Unit Test");
		...
		try{
			 Font font = Font.createFont(Font.TRUETYPE_FONT, grade2OATUnitTestEasy.class.getResourceAsStream("Bungee-Regular.ttf"));
		...
		correctAnswer.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(grade2OATUnitTestEasy.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
        ...
        int y = randomFill(1, 5);
		      	...
		      	String[] questions = 	{"A pencil costs " + i + " cents, and an eraser costs " + j + " cents less than that. How much do a pencil and a sticker cost together?", 
		      			"Richard wants to give " + "$" + k + " to help kids who need school supplies. He also wants to buy shoes for " + "$" + (j+3) + ". How much money will he need for both?",  
		      			"Richard  gets " + "$" + x + " for his allowance each week. How many weeks of saving would it take him to reach his goal of " + "$" + (k+(j+3)) + "?" , "Solve: " + x + " + " + y,"Should " + (x + 4) + " + " + (k+5) + " give same result if the " + (x+4) + " and the " + (k+5) + " were reversed?"};
						...
						public void mousePressed(java.awt.event.MouseEvent evt) {
							...
							question2.addMouseListener(new java.awt.event.MouseAdapter() {
								public void mousePressed(java.awt.event.MouseEvent evt) {
									...
									textArea5.setFont(new Font("Calibri", Font.BOLD, 12));
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,2g2test) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 2g2test =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(grade2OATUnitTestEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(grade2OATUnitTestEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(grade2OATUnitTestEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new grade2OATUnitTestEasy().setVisible(true);
			}
		});
	}
