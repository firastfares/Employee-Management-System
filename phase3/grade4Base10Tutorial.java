...
public class grade4Base10Tutorial extends JFrame {
	...
	private void initComponents() {
		...
		helpbut = new JButton();
		header = new JLabel();
		header.setIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		sidebar = new JLabel();
		sidebar.setIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					grade4Base10Tutorial.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		buttonA.setPressedIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(592, 282, 136, 87);
		panel.add(buttonB);

		JButton buttonC = new JButton();
		buttonC.setPressedIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrow.png")));
		...
		buttonF.setIcon(new ImageIcon(grade4Base10Tutorial.class.getResource("Images/arrowMoveOn.png")));
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(grade4Base10Tutorial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(grade4Base10Tutorial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(grade4Base10Tutorial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new grade4Base10Tutorial().setVisible(true);
			}
		});
	}
