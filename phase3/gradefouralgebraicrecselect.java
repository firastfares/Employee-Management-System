 ...
 * @author John Legg
 */
public class gradefouralgebraicrecselect extends javax.swing.JFrame {


    public gradefouralgebraicrecselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Recordings On Fourth Grade Operations and Algebraic Thinking");//text of label
        ...
        mutlicomp.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=a8BXdGhF2-A"; // open this video on multiplication a comparison
        ...
        factorpairs.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=KcKOM7Degu0"; // open this video on factor pairs 1-100
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        wordproblems.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=E5UfrnbTPGo"; // open this video on word problems on multiplicative comparison
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradefouralgebraicrecselect().setVisible(true);
            }
        });
    }
