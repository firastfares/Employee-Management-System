...
public class gradefourbasetenunittesthard extends JFrame {
	...
	public gradefourbasetenunittesthard() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					gradefourbasetenunittesthard.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		headerTitle.setText("Grade 4 Base 10 Unit Test - Advanced");
		...
		correctAnswer.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);


		incorrectAnswer.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);


		buttonC.setPressedIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(gradefourbasetenunittesthard.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
		...
		int i = randomFill(100,5000);
		int j = randomFill(100,5000);
		int t = randomFill(10,99);//two digit
		int m = randomFill(1000,4000);//four digit number
		int k = randomFill(10,99);//two digit num
		int l = randomFill(10,99);//two digit num
		int n = randomFill(100,5000);
		int p = randomFill(100,5000);
		...
		String[] questions = 	{"Is the Ten-thousands place ten times as large as the thousands place? YES or NO",
					...
					buttonF.addMouseListener(new MouseAdapter() {
						...
						//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
							...
							percentage.setText(result+"%");
									...
									String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,4g3testhard) \n" +
											"VALUES (?,?)\n" +
											" on DUPLICATE key update 4g3testhard =?";
									try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(gradefourbasetenunittesthard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(gradefourbasetenunittesthard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(gradefourbasetenunittesthard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new gradefourbasetenunittesthard().setVisible(true);
			}
		});
	}
