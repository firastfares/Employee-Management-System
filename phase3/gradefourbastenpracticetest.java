...
public class gradefourbastenpracticetest extends JFrame {
	...
	public gradefourbastenpracticetest() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					gradefourbastenpracticetest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		hintButton.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton3.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton4.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton5.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		headerTitle.setText("Grade 4 Base10 Practice");
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, gradefourbastenpracticetest.class.getResourceAsStream("Bungee-Regular.ttf"));
	       }
		catch(Exception e){}
		...
		correctAnswer.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(gradefourbastenpracticetest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
		...
		int i = randomFill(100,2000);
		int j = randomFill(100,2000);
		int t = randomFill(2,9);//one digit
		int m = randomFill(1000,4000);//four digit number
		int k = randomFill(10,99);//two digit num
		int l = randomFill(10,99);//two digit num
		int n = randomFill(100,2000);
		int p = randomFill(100,2000);
					...
					String[] questions = 	{"Is the hundreds place ten times as large as the ten place? YES or NO",
							"Solve: " + (j) + " - " + i, "Solve: " + (m) + " x " + (t),
							"Solve: "+(l) + " x " + k, "Solve: " + (n) + " + " + p};
					...
					String[] answer = {"yes", ""+((j)-i),""+(m*t), "" + (l*k), ""+ ((n)+p)};
					...
					String[] hints = {"Consider how place value increments ",
							"Try to use borrowing methods when subtracting", "Try multiplying by lining up the place values and multiply each digit by "+ t,
							"Try multiplying by lining up the place values and multiply by the ones place and then tens place ex. 39x 24 you do 39 x 4 and then 39x20", "Try use to regrouping or carrying when adding "};
			      ...
			      //This if statements is used to sort out random number awkwardness for the subtraction problem.
					...
					if ((j) < i)
					{
						...
						answer[1] = (""+(i - (j)));
						hints[1] = "Try to use borrowing methods when subtracting";
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, "The answer is: " + answer[0]+". Consider how place value increments."); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
				...
				public void mousePressed(MouseEvent evt) {
					...
					try{
			      		...
			      		else
						{
							...
							{
			      			clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[1] + ". Next time, try to break the subtraction into place values starting with ones place borrowing a group of ten");
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[2] + ". Next time, Try multiplying by lining up the place values and multiply each digit by "+ t );
			...
			submitAnswer4.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[3] + ". Next time, Try multiplying by lining up the place values and multiply by the ones place and then tens place ex. 39x 24 you do 39 x 4 and then 39x20");
							submitAnswer4.setVisible(false);
				...
				public void mousePressed(MouseEvent evt) {
					try{
						...
						if (clicked == 3)
						{
							...
							JOptionPane.showMessageDialog(panel, "The answer is "+ answer[4] + ". Next time, try to break the subtraction into place values starting with ones place borrowing a group of ten");
							submitAnswer5.setVisible(false);
							buttonF.setVisible(true);
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new MouseAdapter() {
						public void mousePressed(MouseEvent evt) {
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,4g3practice) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 4g3practice =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(gradefourbastenpracticetest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(gradefourbastenpracticetest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(gradefourbastenpracticetest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new gradefourbastenpracticetest().setVisible(true);
			}
		});
	}
