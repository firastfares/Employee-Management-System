 ...
 * @author John Legg
 */
public class gradeonbasetenvidselect extends javax.swing.JFrame {


    public gradeonbasetenvidselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        submutliple10 = new javax.swing.JButton();// button creation
        ...
        title.setText("Videos On First Grade Number and Operation Base Ten");//text of label
        ...
        count120.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=WwGwQ4oGloY"; // open this video on counting to 120
        ...
        twodigitplus10.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=Jq1C_sIm8Q4"; // open this video on Two digit number + multiple of 10
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        submutliple10.setText("Subtract multiples of 10");//button text
        submutliple10.setBackground(new java.awt.Color(139, 139, 139));//button background color
        submutliple10.setOpaque(true);//opaque
        submutliple10.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(64, 121, 126), 10, true));//button borders
        submutliple10.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/1stgradebaseten2.png")));//button icon
        submutliple10.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);//text position
        submutliple10.setVerticalTextPosition(javax.swing.SwingConstants.TOP);//text position
        submutliple10.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=WozN0hJbALM"; // open this video on Subtract multiples of 10 from multiple of 10
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        submutliple10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                compareshapeActionPerformed(evt);
            }
        });
        getContentPane().add(submutliple10);// placement on to the jframe
        submutliple10.setBounds(700, 390, 240, 150);//button size
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradeonbasetenvidselect().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton submutliple10;// variable creation
