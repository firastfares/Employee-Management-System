 ...
 * @author John Legg
 */
public class gradethreegeometryrecselect extends javax.swing.JFrame {


    public gradethreegeometryrecselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Recordings On Third Grade Geometry");//text
        ...
        shapecategories.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video when clicked
                try {
                    String url = "https://www.youtube.com/watch?v=bBgR1QkR9K0"; // open this video on shape categories
        ...
        shapefractions.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video when pressed
                try {
                    String url = "https://www.youtube.com/watch?v=DLhFo9DVlCE"; // open this video shape fractions
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradethreegeometryrecselect().setVisible(true);
