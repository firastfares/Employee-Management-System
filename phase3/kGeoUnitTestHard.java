...
public class kGeoUnitTestHard extends JFrame {

	/**
	 * Creates new form kGeoUnitTestHard
	 */
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 734);
		sidebar.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					kGeoUnitTestHard.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		headerTitle.setBounds(343, 156, 713, 100);
		getContentPane().add(headerTitle);
		headerTitle.setText("Kindergarten Geo Unit Test - Advanced");
		...
		try{
			 Font font = Font.createFont(Font.TRUETYPE_FONT, kGeoUnitTestHard.class.getResourceAsStream("Bungee-Regular.ttf"));
		...
		correctAnswer.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(460, 175, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(kGeoUnitTestHard.class.getResource("Images/arrowMoveOn.png")));
			...
			public void mousePressed(MouseEvent evt) {
				...
				else if (clicked > 1) //if the user clicks it more than once, the relevant page gets opened
				{
					try {
						...
						java.util.logging.Logger.getLogger(unitselectunittestk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
					} catch (InstantiationException ex) {
						java.util.logging.Logger.getLogger(unitselectunittestk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
					} catch (IllegalAccessException ex) {
						java.util.logging.Logger.getLogger(unitselectunittestk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
					...
					unitselectunittestk unitselectunittestk = new unitselectunittestk();
					unitselectunittestk.setVisible(true);
					setVisible(false);//close this page
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
		...
		ImageIcon rhombus = new ImageIcon (getClass().getResource("Images/regularRhombus.png"));
	         ...
	         ImageIcon[] test = {square, circle, triangle, rectangle, pentagon, hexagon, trapezoid, octagon, oval, rhombus};
	         ...
	         else if (p == 9){imageHolder.setIcon(test[8]); m = "Oval";}

	         else if (p == 10){imageHolder.setIcon(test[9]);m = "Rhombus";}
	         ...
	         else if (p1 == 9){imageHolder2.setIcon(test[8]); n = "Oval";}

	         else if (p1 == 10){imageHolder2.setIcon(test[9]);n = "Rhombus";}
         ...
         if (p2 == 1){imageHolder3.setIcon(test[0]); o = "Square";}
	         ...
	         else if (p2 == 9){imageHolder3.setIcon(test[8]); o = "Oval";}

	         else if (p2 == 10){imageHolder3.setIcon(test[9]);o = "Rhombus";}
         ...
         if (p3 == 1){imageHolder4.setIcon(test[0]); y = "Square";}
	         ...
	         else if (p3 == 9){imageHolder4.setIcon(test[8]); y = "Oval";}

	         else if (p3 == 10){imageHolder4.setIcon(test[9]); y = "Rhombus";}
         ...
         else if (p4 == 9){imageHolder4.setIcon(test[8]); z = "Oval"; x = "0";}

         else if (p4 == 10){imageHolder4.setIcon(test[9]);z = "Rhombus"; x = "4";}
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							////Current subtmitAnswer button disappears
														...
														//resetting the click variable to 0.
								JOptionPane.showMessageDialog(panel, "This shape is a " + answer[0] + "!"); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
			...
			buttonA.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					while (p == p1)
					{
			         ...
			         else if (p == 9){imageHolderDummy.setIcon(test[8]);}

			         else if (p == 10){imageHolderDummy.setIcon(test[9]);}
				...
				public void mousePressed(MouseEvent evt) {
					...
					try{
			      		...
			      		else
						{
							...
							JOptionPane.showMessageDialog(panel, "The shape on the right is a " + answer[1] +  "!");
			...
			buttonB.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					while (p == p2)
					{
			         ...
			         if (p == 1){imageHolderDummy2.setIcon(test[0]);}
			         ...
			         else if (p == 9){imageHolderDummy2.setIcon(test[8]);}

			         else if (p == 10){imageHolderDummy2.setIcon(test[9]);}
					  ...
					  submitAnswer3.setBounds(153, 266, 340, 41);
				...
				public void mousePressed(MouseEvent evt) {
					try{
			      		...
			      		else
						{
							...
							JOptionPane.showMessageDialog(panel, "The " + o + " is on the " + answer[2] + "!");
							submitAnswer3.setVisible(false);
							buttonC.setVisible(true);
			...
			buttonD.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					while (p == p3)
					{
			         ...
			         else if (p == 9){imageHolderDummy3.setIcon(test[8]);}

			         else if (p == 10){imageHolderDummy3.setIcon(test[9]);}
				...
				public void mousePressed(MouseEvent evt) {
					try{
			      		...
			      		else
						{
							...
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[4] + "!");
							submitAnswer5.setVisible(false);
							buttonF.setVisible(true);
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new MouseAdapter() {
						public void mousePressed(MouseEvent evt) {
							...
							correctAnswer1.setBounds(170, 4, 387, 52);
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,k1testhard) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update k1testhard =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(kGeoUnitTestHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(kGeoUnitTestHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(kGeoUnitTestHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new kGeoUnitTestHard().setVisible(true);
			}
		});
	}
