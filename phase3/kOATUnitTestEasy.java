...
public class kOATUnitTestEasy extends JFrame {

	/**
	 * Creates new form kOATUnitTestEasy
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 734);
		sidebar.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					kOATUnitTestEasy.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		headerTitle.setText("Kindergarten O/A Unit Test");
		...
		try{
			 Font font = Font.createFont(Font.TRUETYPE_FONT, kOATUnitTestEasy.class.getResourceAsStream("Bungee-Regular.ttf"));
		...
		correctAnswer.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(kOATUnitTestEasy.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
	         ...
	         int x = randomFill(2, 5);
	         int y = randomFill(3, 6);
			      	...
			      	String[] questions = 	{"Derek has " + i + " cucumbers, and Damian has " + (i-1) + " cucumbers. How many cucumbers do they have together?", 
			      			"There are " + x + " small rocks and " + y + " big rocks. How many rocks are there altogether?",
			      			"Arnold picked " + (y+2) + " oranges and gave " + (x+2) + " to his friend. How many does he have left?",
			      					
			      			"Jen bought a candy for " + k + " cents, and popcorn for " + (x+5) + " cents. How much did she spend? Enter a number only.", "Solve: " + (k-2) + " - " + (i-2)}; 
			      	...
			      	String[] answer = {""+(i+(i-1)), ""+(x+y), ""+((y+2)-(x+2)), "" + ((k)+(x+5)), "" + ((k-2)-(i-2))};
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new java.awt.event.MouseAdapter() {
						public void mousePressed(java.awt.event.MouseEvent evt) {
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,k2test) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update k2test =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(kOATUnitTestEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(kOATUnitTestEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(kOATUnitTestEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new kOATUnitTestEasy().setVisible(true);
			}
		});
	}
