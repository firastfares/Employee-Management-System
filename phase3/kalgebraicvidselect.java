 ...
 * @author John Legg
 */
public class kalgebraicvidselect extends javax.swing.JFrame {


    public kalgebraicvidselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        dinoaddsub = new javax.swing.JButton();//button creation
        ...
        title.setText("Videos On Kindergarten Operations and Algebraic Thinking");//text of label
        getContentPane().add(title);//label placement
        title.setBounds(50, 180, 900, 60);//label size

        dinoaddsub.setText("Dino addition and subtraction");//text
        dinoaddsub.setBackground(new java.awt.Color(139, 139, 139));//button background color
        dinoaddsub.setOpaque(true);//opaque
        dinoaddsub.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(64, 121, 126), 10, true));//button borders
        dinoaddsub.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/kideralgebraic.png")));//button icon
        dinoaddsub.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);//text position
        dinoaddsub.setVerticalTextPosition(javax.swing.SwingConstants.TOP);//text position
        dinoaddsub.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=igcoDFokKzU"; // open this video on addition and subtraction with objects
        ...
        dinoaddsub.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                whatshapeActionPerformed(evt);
            }
        });
        getContentPane().add(dinoaddsub);//placement on jframe
        dinoaddsub.setBounds(120, 390, 240, 150);//button size
        ...
        addsubtract.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=3AQ9v0bUOpI"; // open this video on addition and subtraction within 5
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        wordproblems.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=W6Uux8w_GNI"; // open this video on word problems of add and subtract within 10
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kalgebraicvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(kalgebraicvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(kalgebraicvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new kalgebraicvidselect().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton dinoaddsub;// variable creation
