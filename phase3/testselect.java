...
public class testselect extends javax.swing.JFrame {
    ...
    private void NextbutMouseClicked(MouseEvent evt) {
        homepagev2 homepagev2 = new homepagev2();
        homepagev2.setVisible(true);
    }

    private void test1butMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_practicetestbutMouseClicked
        tutorialtemplate test1 = new tutorialtemplate();
        test1.setVisible(true);
    }

    private void test2butMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_practicetestbutMouseClicked
        unitTest2 unitTest2 = new unitTest2();
        unitTest2.setVisible(true);
    }
