 ...
 * @author John Legg
 */
public class testselectunittest1algebraic extends JFrame {


    public testselectunittest1algebraic() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("1st Grade Algebraic  Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                grade1OATUnitTestEasy grade1OATUnitTestEasy  = new grade1OATUnitTestEasy();
                grade1OATUnitTestEasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                grade1OATUnitTestHard grade1OATUnitTestHard  = new grade1OATUnitTestHard();
                grade1OATUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest1algebraic().setVisible(true);
            }
        });
    }
