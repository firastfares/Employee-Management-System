 ...
 * @author John Legg
 */
public class testselectunittest2algebraic extends JFrame {


    public testselectunittest2algebraic() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("2nd Grade Algebraic Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                grade2OATUnitTestEasy grade2OATUnitTestEasy = new grade2OATUnitTestEasy();
                grade2OATUnitTestEasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open  test
                ...
                grade2OATUnitTestHard grade2OATUnitTestHard = new grade2OATUnitTestHard();
                grade2OATUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest2algebraic().setVisible(true);
            }
        });
    }
