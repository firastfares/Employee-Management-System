 ...
 * @author John Legg
 */
public class testselectunittest2geo extends JFrame {


    public testselectunittest2geo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("2nd Grade Geometry Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade2GeoUnitTestEasy grade2GeoUnitTestEasy = new grade2GeoUnitTestEasy();
                grade2GeoUnitTestEasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade2GeoUnitTestHard grade2GeoUnitTestHard = new grade2GeoUnitTestHard();
                grade2GeoUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest2geo().setVisible(true);
            }
        });
    }
