 ...
 * @author John Legg
 */
public class testselectunittest3baseten extends JFrame {


    public testselectunittest3baseten() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("3rd Grade Base Ten Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                gradethreebasetenunittesteasy gradethreebasetenunittesteasy = new gradethreebasetenunittesteasy();
                gradethreebasetenunittesteasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                gradethreebasetenunittesthard gradethreebasetenunittesthard = new gradethreebasetenunittesthard();
                gradethreebasetenunittesthard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest3baseten().setVisible(true);
            }
        });
    }
