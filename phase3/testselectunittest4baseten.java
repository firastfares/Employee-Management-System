 ...
 * @author John Legg
 */
public class testselectunittest4baseten extends JFrame {


    public testselectunittest4baseten() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("4th Grade Base Ten Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                gradefourbasetenunittesteasy gradefourbasetenunittesteasy = new gradefourbasetenunittesteasy();
                gradefourbasetenunittesteasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                gradefourbasetenunittesthard gradefourbasetenunittesthard = new gradefourbasetenunittesthard();
                gradefourbasetenunittesthard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest4baseten().setVisible(true);
            }
        });
    }
