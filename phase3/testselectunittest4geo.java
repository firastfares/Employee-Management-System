 ...
 * @author John Legg
 */
public class testselectunittest4geo extends JFrame {


    public testselectunittest4geo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("4th Grade Geometry Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade4GeoUnitTest grade4GeoUnitTest = new grade4GeoUnitTest();
                grade4GeoUnitTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade4GeoUnitTestHard grade4GeoUnitTestHard = new grade4GeoUnitTestHard();
                grade4GeoUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest4geo().setVisible(true);
            }
        });
    }
