 ...
 * @author John Legg
 */
public class unitselectpracticetestgfour extends JFrame {


    public unitselectpracticetestgfour() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Fourth Grade Select a Unit Practice");//text
        ...
        geometry.setIcon(new ImageIcon(getClass().getResource("Images/4thgradegeometry.png")));//button icon
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade4GeoPracticeTest grade4GeoPracticeTest = new grade4GeoPracticeTest();
                grade4GeoPracticeTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.setIcon(new ImageIcon(getClass().getResource("Images/4thgradealgebraic2.png")));//button icon
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade4OATPracticeTest grade4OATPracticeTest = new grade4OATPracticeTest();
                grade4OATPracticeTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.setIcon(new ImageIcon(getClass().getResource("Images/4thgradebaseten3.jpg")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                gradefourbastenpracticetest gradefourbastenpracticetest = new gradefourbastenpracticetest();
                gradefourbastenpracticetest.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectpracticetestgfour().setVisible(true);
            }
        });
    }
