 ...
 * @author John Legg
 */
public class unitselectpracticetestgtwo extends JFrame {


    public unitselectpracticetestgtwo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Second Grade Select a Unit Practice");//text
        ...
        geometry.setIcon(new ImageIcon(getClass().getResource("Images/2ndgradegeometry.png")));//button icon
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade2GeoPracticeTest grade2GeoPracticeTest = new grade2GeoPracticeTest();
                grade2GeoPracticeTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.setIcon(new ImageIcon(getClass().getResource("Images/2ndgradealgebraic.png")));//button icon
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade2OATPracticeTest grade2OATPracticeTest = new grade2OATPracticeTest();
                grade2OATPracticeTest.setVisible(true);
                setVisible(false);
        ...
        baseten.setIcon(new ImageIcon(getClass().getResource("Images/2ndgradebaseten.png")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                gradetwobasetenPracticeTest gradetwobasetenPracticeTest = new gradetwobasetenPracticeTest();
                gradetwobasetenPracticeTest.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectpracticetestgtwo().setVisible(true);
            }
        });
    }
