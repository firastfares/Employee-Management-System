 ...
 * @author John Legg
 */
public class unitselectrecordingsgfour extends JFrame {


    public unitselectrecordingsgfour() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Grade 4 Select a Unit to Watch");//text
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                try {
                    for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                        if ("Nimbus".equals(info.getName())) {
                            javax.swing.UIManager.setLookAndFeel(info.getClassName());
                    ...
                    java.util.logging.Logger.getLogger(gradefourgeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradefourgeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradefourgeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradefourgeometryrecselect gradefourgeometryrecselect = new gradefourgeometryrecselect();
                gradefourgeometryrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradefouralgebraicrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradefouralgebraicrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradefouralgebraicrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradefouralgebraicrecselect gradefouralgebraicrecselect = new gradefouralgebraicrecselect();
                gradefouralgebraicrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradefourbasetenrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradefourbasetenrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradefourbasetenrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradefourbasetenrecselect gradefourbasetenrecselect = new gradefourbasetenrecselect();
                gradefourbasetenrecselect.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitselectrecordingsgfour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsgfour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsgfour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectrecordingsgfour().setVisible(true);
            }
        });
    }
