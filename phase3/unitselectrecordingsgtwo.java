 ...
 * @author John Legg
 */
public class unitselectrecordingsgtwo extends JFrame {


    public unitselectrecordingsgtwo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Grade 2 Select a Unit to watch");//text
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradetwogeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradetwogeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradetwogeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradetwogeometryrecselect gradetwogeometryrecselect = new gradetwogeometryrecselect();
                gradetwogeometryrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                ...
                gradetwoalgebraicrecselect gradetwoalgebraicrecselect =  new gradetwoalgebraicrecselect();
                gradetwoalgebraicrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradetwobasetenrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger( gradetwobasetenrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger( gradetwobasetenrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradetwobasetenrecselect gradetwobasetenrecselect = new gradetwobasetenrecselect();
                gradetwobasetenrecselect.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitselectrecordingsgtwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsgtwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsgtwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectrecordingsgtwo().setVisible(true);
            }
        });
    }
