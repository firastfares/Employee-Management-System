 ...
 * @author John Legg
 */
public class unitselectrecordingsk extends JFrame {


    public unitselectrecordingsk() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                try {
                    ...
                    java.util.logging.Logger.getLogger( kgeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger( kgeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger( kgeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                kgeometryrecselect kgeometryrecselect = new kgeometryrecselect();
                kgeometryrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                ...
                kalgebraicrecselect kalgebraicrecselect = new kalgebraicrecselect();
                kalgebraicrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording page
                try {
                    for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                        if ("Nimbus".equals(info.getName())) {
                            javax.swing.UIManager.setLookAndFeel(info.getClassName());
                ...
                kbasetenrecselect kbasetenrecselect = new kbasetenrecselect();
                kbasetenrecselect.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitselectrecordingsk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectrecordingsk().setVisible(true);
            }
        });
    }
