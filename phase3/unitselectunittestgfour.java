 ...
 * @author John Legg
 */
public class unitselectunittestgfour extends JFrame {


    public unitselectunittestgfour() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Grade 4 Select a Unit Test");//text
        ...
        geometry.setIcon(new ImageIcon(getClass().getResource("Images/moreproblemsgeo3.png")));//button icon
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                        if ("Nimbus".equals(info.getName())) {
                            javax.swing.UIManager.setLookAndFeel(info.getClassName());
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest4geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest4geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest4geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest4geo testselectunittest4geo = new testselectunittest4geo();
                testselectunittest4geo.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.setIcon(new ImageIcon(getClass().getResource("Images/moreproblemsalgebraic.png")));//button icon
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest4algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest4algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest4algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest4algebraic testselectunittest4algebraic = new testselectunittest4algebraic();
                testselectunittest4algebraic.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.setIcon(new ImageIcon(getClass().getResource("Images/4thgradebaseten.png")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest4baseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest4baseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest4baseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest4baseten testselectunittest4baseten = new testselectunittest4baseten();
                testselectunittest4baseten.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectunittestgfour().setVisible(true);
            }
        });
    }
