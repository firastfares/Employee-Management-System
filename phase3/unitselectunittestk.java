 ...
 * @author John Legg
 */
public class unitselectunittestk extends JFrame {


    public unitselectunittestk() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Kindergarten Select a Unit Test");//text
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittestkgeo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittestkgeo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittestkgeo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittestkgeo testselectunittestkgeo = new testselectunittestkgeo();
                testselectunittestkgeo.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittestkalgebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittestkalgebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittestkalgebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittestkalgebraic testselectunittestkalgebraic = new testselectunittestkalgebraic();
                testselectunittestkalgebraic.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittestkbaseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittestkbaseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittestkbaseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittestkbaseten testselectunittestkbaseten = new testselectunittestkbaseten();
                testselectunittestkbaseten.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectunittestk().setVisible(true);
            }
        });
    }
