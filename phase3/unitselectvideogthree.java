 ...
 * @author John Legg
 */
public class unitselectvideogthree extends JFrame {


    public unitselectvideogthree() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradethreegeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradethreegeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradethreegeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradethreegeometryvidselect gradethreegeometryvidselect = new gradethreegeometryvidselect();
                gradethreegeometryvidselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                ...
                gradethreealgebraicvidselect gradethreealgebraicvidselect = new gradethreealgebraicvidselect();
                gradethreealgebraicvidselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradethreebasetenvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradethreebasetenvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradethreebasetenvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradethreebasetenvidselect gradethreebasetenvidselect = new gradethreebasetenvidselect();
                gradethreebasetenvidselect.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitselectvideogthree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(unitselectvideogthree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(unitselectvideogthree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectvideogthree().setVisible(true);
            }
        });
    }
