 ...
 * @author John Legg
 */
public class unitselectvideok extends JFrame {


    public unitselectvideok() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Kindergarten Select a Unit to Watch");//text
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open videos
                try {
                    for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                        if ("Nimbus".equals(info.getName())) {
                            javax.swing.UIManager.setLookAndFeel(info.getClassName());
                    ...
                    java.util.logging.Logger.getLogger(kgeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(kgeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(kgeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                kgeometryvidselect kgeometryvidselect = new kgeometryvidselect();
                kgeometryvidselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open videos
                ...
                kalgebraicvidselect kalgebraicvidselect = new kalgebraicvidselect();
                kalgebraicvidselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                try {
                    ...
                    java.util.logging.Logger.getLogger(kbasetenvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(kbasetenvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(kbasetenvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                kbasetenvidselect kbasetenvidselect = new kbasetenvidselect();
                kbasetenvidselect.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitselectvideok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(unitselectvideok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(unitselectvideok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectvideok().setVisible(true);
            }
        });
    }
