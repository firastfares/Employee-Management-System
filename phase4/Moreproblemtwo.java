 ...
 * @author John Legg
 */
public class Moreproblemtwo extends javax.swing.JFrame {

    public Moreproblemtwo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("More Problems Second Grade");//text
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.education.com/worksheets/second-grade/geometry/"; // open and another kids math app.
        ...
        baseten.setIcon(new javax.swing.ImageIcon(getClass().getResource("Images/2ndgradebaseten.png")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.khanacademy.org/math/cc-2nd-grade-math/cc-2nd-place-value"; // open and another kids math app.
                    Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {// open webpage when clicked on
                try {
                    String url = "https://www.khanacademy.org/math/cc-2nd-grade-math/cc-2nd-add-subtract-100"; // open and another kids math app.
                    Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Moreproblemtwo().setVisible(true);
            }
        });
    }
