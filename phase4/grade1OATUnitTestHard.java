...
public class grade1OATUnitTestHard extends JFrame {

	/**
	 * Creates new form grade1OATUnitTestHard
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 734);
		sidebar.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					grade1OATUnitTestHard.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		headerTitle.setText("Grade 1 O/A Unit Test - Advanced");
		...
		try{
			 Font font = Font.createFont(Font.TRUETYPE_FONT, grade1OATUnitTestHard.class.getResourceAsStream("Bungee-Regular.ttf"));
		...
		correctAnswer.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(grade1OATUnitTestHard.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
        ...
        int i = randomFill(3, 10);
        int k = randomFill(6, 15);
        int x = randomFill(7, 15);
        int y = randomFill(6, 10);
		      	...
		      	String[] questions = 	{"There were " + x + " people at the meeting. Then " + y + " showed up. How many people were at the meeting altogether?", 
		      			"There were " + (x+3) + " people at the meeting. Then some more showed up. There were " + ((x+3)+(y+2)) + " people in all. How many people came?",
		      			"Tom said that " + (k-1) + " + " + k + " should be " + (k+k) + ". Is he correct? Enter yes or no.", 
		      	...
		      	String[] answer = {""+(x+y), ""+(((x+3)+(y+2) - (x+3))), "no", "" + ((x+1)-(y-1)), "" + i};
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new java.awt.event.MouseAdapter() {
						public void mousePressed(java.awt.event.MouseEvent evt) {
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,1g2testhard) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 1g2testhard =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(grade1OATUnitTestHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(grade1OATUnitTestHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(grade1OATUnitTestHard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new grade1OATUnitTestHard().setVisible(true);
			}
		});
	}
