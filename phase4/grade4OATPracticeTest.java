...
public class grade4OATPracticeTest extends JFrame {

	/**
	 * Creates new form grade4OATPracticeTest
	 */
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 734);
		sidebar.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					grade4OATPracticeTest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		hintButton.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton3.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton4.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton5.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		headerTitle.setText("Grade 4 O/A Practice Test");
		...
		correctAnswer.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(grade4OATPracticeTest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
	         ...
	         int i = randomFill(10, 15);
	         int j = randomFill(2, 9);
	         int k = randomFill(1, 10);
	         int x = randomFill(2, 4);
	         int y = randomFill(1, 5);
			      	...
			      	String[] questions = 	{"Hannah raised " + i + " dollars for the food bank last year and raised " + j + " times as much this year. How much did she raise this year?", 
			      			"Complete the next number in this sequence: " + x*1 + " " + x*2 + " " + x*3+ " " + x*4, "Carl's rectangular vegetable garden is " + i + " feet " + " by " + (k*3) + " feet. How large is his garden in area?", 
			      			"Luis raised " + i*3 + " dollars for the animal shelter, which was " + 3 + " times as much as Tim raised. How much money did Tim raise? ", "Jane has " + (y*10) + " candy bars and Jim has " + (y*100) + ". How many more candy bars does Jim have than Jane?"};
			      	...
			      	String[] answer = {""+(i*j), ""+(x*5),""+(i*(k*3)), "" + (i*3/3), "" + (y*100)/(y*10)};
			      	...
			      	String[] hints = {"This problem can be solved by multiplication!", 
			      			"Do you notice a pattern? How much is " + x + " increasing by each time?", "How do we solve area problems?", "Example: Nita raised 3 times as much as Sandra.\r\n" + 
			      					"3 x ? = 45 is equivalent to 45/3 = ?", "Try to recall the multiplicative relationship between numbers by using your understanding of place value!"};
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, "The answer is " + answer[0] + " because she raised " + j + " times as much money!"); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
				...
				public void mousePressed(MouseEvent evt) {
					...
					try{
			      		...
			      		else
						{
							...
							{
			      			clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[1] + ". Next time, try observe the pattern that the numbers seem to be incrementing by!");
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[2] + ". Next time, try to recall that area problems for rectangles are solved by multiplying the LENGTH " + "(" + i + ") "+" by the WIDTH " + "(" + (k*3) + ")!"  );
			...
			submitAnswer4.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[3] + ". Next time, try to recognize this as a Numbers of Groups Unknown Problem!");
							submitAnswer4.setVisible(false);
				...
				public void mousePressed(MouseEvent evt) {
					try{
						...
						if (clicked == 3)
						{
							...
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[4] + ". Try to recall the multiplicative relationship between numbers by using your understanding of place value!");
							submitAnswer5.setVisible(false);
							buttonF.setVisible(true);
						...
						public void mousePressed(MouseEvent evt) {
							...
							question5.addMouseListener(new MouseAdapter() {
								public void mousePressed(MouseEvent evt) {
									...
									textArea5.setFont(new Font("Calibri", Font.BOLD, 17));
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,4g2practice) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 4g2practice =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(grade4OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(grade4OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(grade4OATPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new grade4OATPracticeTest().setVisible(true);
			}
		});
	}
