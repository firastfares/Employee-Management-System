...
public class gradefourbasetenunittesteasy extends JFrame {
	...
	//There are 5 submitAnswer buttons, 5 arrow buttons (these are buttonA, buttonB, buttonC, buttonD, and buttonF), and there are 5 text fields that read input from the user. These text fields are textAnswer, questionB, questionC, questionD, and questionE
	...
	public gradefourbasetenunittesteasy() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					gradefourbasetenunittesteasy.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		headerTitle.setText("Grade 4 Base 10 Easy Unit Test");
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, gradefourbasetenunittesteasy.class.getResourceAsStream("Bungee-Regular.ttf"));
	       }
		catch(Exception e){}
		...
		correctAnswer.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(gradefourbasetenunittesteasy.class.getResource("Images/arrowMoveOn.png")));
		...
		warningMessage.setText("Make sure you have completed the test and reviewed your results before navigating away from this page! <p> Navigating away before the the test is complete means your answers may not be saved! "
...
//Kind of a crude implementation but it works and it's flexible
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new MouseAdapter() {
						public void mousePressed(MouseEvent evt) {
							...
							try{
						           Font font = Font.createFont(Font.TRUETYPE_FONT, gradeonebasetenunittesteasy.class.getResourceAsStream("Bungee-Regular.ttf"));
							...
							returntoResults.addMouseListener(new MouseAdapter() {
								public void mousePressed(MouseEvent evt) {
									...
									correctInWords.setVisible(false);correctAnswer1.setVisible(false);
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,4g3test) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 4g3test =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(gradefourbasetenunittesteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(gradefourbasetenunittesteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(gradefourbasetenunittesteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new gradefourbasetenunittesteasy().setVisible(true);
			}
		});
	}
