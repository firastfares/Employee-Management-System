 ...
 * @author John Legg
 */
public class gradefourgeometryvidselect extends javax.swing.JFrame {


    public gradefourgeometryvidselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Videos On Fourth Grade Geometry");//text
        ...
        whatareangles.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video when pressed
                try {
                    String url = "https://www.youtube.com/watch?v=g7K4zztMXT0"; // open this video on angles
        ...
        shapeidentifcation.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open the video when pressed
                try {
                    String url = "https://www.youtube.com/watch?v=xO4n3LfmVag"; // open this video shape identification base lines and angles
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
