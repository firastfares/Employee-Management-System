...
public class gradeonebasetenPracticeTest extends JFrame {
	...
	public gradeonebasetenPracticeTest() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					gradeonebasetenPracticeTest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		hintButton.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton3.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton4.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton5.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		headerTitle.setText("Grade 1 Base10 Practice");
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, gradeonebasetenPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
	       }
		catch(Exception e){}
		...
		correctAnswer.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(gradeonebasetenPracticeTest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
	         ...
	         int i = randomFill(1, 10)*10; //multiple of 10
	         int j = randomFill(1, 10)*10;//multiple 10
		     int t = randomFill(1, 5)*10; //multiple of 10
		     int m = randomFill(10, 50);//two digit number within 100 when added
	         int k = randomFill(1, 5)*10; //multiple of 10
		     int l = randomFill(10,50);//two digit number within 100 when added
	         int n = randomFill(1, 10)*10;//multiple 10
	         int p = randomFill(1, 10)*10;//multiple 10
		     int q1 = 26;
	         ...
	         //Collections.shuffle(Arrays.asList(wordProblems));
			      	...
			      	String[] questions = 	{"How many questions marks is this: "+"? ? ? ? ? ? ? ? ? ?"+"? ? ? ? ? ? ? ? ? ?"+"? ? ? ? ? ?",
			      			"Solve: " + (j) + " - " + i, "Solve: "+(m+1) + " + " + t,
			      			"Solve: "+(l) + " + " + k, "Solve: " + (n) + " - " + p};
			      	...
			      	String[] answer = {""+(q1), ""+((j)-i),""+((m+1)+t), "" + ((l)+k), ""+ ((n)-p)};
			      	...
			      	String[] hints = {"Try counting it by breaking into chunks of tens ",
			      			"Try to think of the problem as removing " + i + " sticks from a pile of " + (j) + " sticks!", "Try to think of the problem as adding "+t,"cookies into cookie jar with "+ (m+1) +" cookies",
							"Try to think of the problem as adding "+k,"cookies into cookie jar with "+ (l) +" cookies", "Try to think of the problem as removing " + p + " sticks from a pile of " + (n) + " sticks!"};
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, "Try counting it by breaking into chunks of tens "); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is "+ answer[2]+ "Try just to add how ever many tens exist ex. 20 is adding ten twice"  );
				...
				public void mousePressed(MouseEvent evt) {
					try{
						...
						if (clicked == 3)
						{
							...
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[4] + ". Next time, try to think of the problem as removing sticks from the larger pile of sticks!");
							submitAnswer5.setVisible(false);
							buttonF.setVisible(true);
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new MouseAdapter() {
						public void mousePressed(MouseEvent evt) {
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,1g3practice) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 1g3practice =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(gradeonebasetenPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(gradeonebasetenPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(gradeonebasetenPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new gradeonebasetenPracticeTest().setVisible(true);
			}
		});
	}
