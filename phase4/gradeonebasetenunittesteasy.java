...
public class gradeonebasetenunittesteasy extends JFrame {
	...
	public gradeonebasetenunittesteasy() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					gradeonebasetenunittesteasy.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		headerTitle.setText("Grade 1 Base 10 Easy Unit Test");
		...
		correctAnswer.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(gradeonebasetenunittesteasy.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
						...
						//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
							resultsBut.addMouseListener(new MouseAdapter() {
								public void mousePressed(MouseEvent evt) {
									...
									try{
								           Font font = Font.createFont(Font.TRUETYPE_FONT, gradefourbasetenunittesthard.class.getResourceAsStream("Bungee-Regular.ttf"));
							...
							percentage.setText(result+"%");
									...
									String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,1g3test) \n" +
											"VALUES (?,?)\n" +
											" on DUPLICATE key update 1g3test =?";
									try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(gradeonebasetenunittesteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(gradeonebasetenunittesteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(gradeonebasetenunittesteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new gradeonebasetenunittesteasy().setVisible(true);
			}
		});
	}
