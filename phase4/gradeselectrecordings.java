 ...
 * @author John Legg
 */
public class gradeselectrecordings extends JFrame {


    public gradeselectrecordings() { initComponents();
    }
    ...
    private void initComponents() {
        ...
        kindergarden.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  kindergarten
                ...
                unitselectrecordingsk unitselectrecordingsk = new unitselectrecordingsk();
                unitselectrecordingsk.setVisible(true);//open unit select
                setVisible(false);//close grade select
        ...
        firstgrade.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  grade one
                ...
                unitselectrecordingsgone unitselectrecordingsgone = new unitselectrecordingsgone();
                unitselectrecordingsgone.setVisible(true);//open unit select
                setVisible(false);//close grade select
        ...
        secondgrade.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  second grade
                ...
                unitselectrecordingsgtwo unitselectrecordingsgtwo = new unitselectrecordingsgtwo();
                unitselectrecordingsgtwo.setVisible(true);//open unit select
                setVisible(false);//close grade select
        ...
        thirdgrade.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  third grade
                ...
                unitselectrecordingsgthree unitselectrecordingsgthree = new unitselectrecordingsgthree();
                unitselectrecordingsgthree.setVisible(true);//open unit select
                setVisible(false);//close grade select
        ...
        fourthgrade.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  fourth grade
                ...
                unitselectrecordingsgfour unitselectrecordingsgfour = new unitselectrecordingsgfour();
                unitselectrecordingsgfour.setVisible(true);//open unit select
                setVisible(false);//close grade select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradeselectrecordings().setVisible(true);
            }
        });
    }
