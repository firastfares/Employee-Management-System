 ...
 * @author John Legg
 */
public class gradeselectvideos extends JFrame {


    public gradeselectvideos() { initComponents();
    }
    ...
    private void initComponents() {
        ...
        kindergarden.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  kindergarten
                ...
                unitselectvideok unitselectvideok = new unitselectvideok();
                unitselectvideok.setVisible(true);//open unit select
                setVisible(false);//close grade select
        ...
        firstgrade.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  grade one
                ...
                unitselectvideogone unitselectvideogone = new unitselectvideogone();
                unitselectvideogone.setVisible(true);//open unit select
                setVisible(false);//close grade select
        ...
        secondgrade.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  second grade
                ...
                unitselectvideogtwo unitselectvideogtwo = new unitselectvideogtwo();
                unitselectvideogtwo.setVisible(true);//open unit select
                setVisible(false);//close grade select
        ...
        thirdgrade.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  third grade
                ...
                unitselectvideogthree unitselectvideogthree = new unitselectvideogthree();
                unitselectvideogthree.setVisible(true);//open unit select
                setVisible(false);//close grade select
        ...
        fourthgrade.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit select  fourth grade
                ...
                unitselectvideogfour unitselectvideogfour = new unitselectvideogfour();
                unitselectvideogfour.setVisible(true);//open unit select
                setVisible(false);//close grade select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradeselectvideos().setVisible(true);
            }
        });
    }
