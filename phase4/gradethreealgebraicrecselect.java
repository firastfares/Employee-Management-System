 ...
 * @author John Legg
 */
public class gradethreealgebraicrecselect extends javax.swing.JFrame {


    public gradethreealgebraicrecselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Recordings On Grade Three Operations and Algebraic Thinking");//text of label
        ...
        multiplydivide.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=1im4DOvgstY"; // open this video on multiplying and dividing within 100
        ...
        mutliprops.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=8ALuD3BR938"; // open this video on multiplication properties.
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        wordproblems.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=i9iGu_gDOU0"; // open this video on Word Problems on multiplication and division within 100
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradethreealgebraicrecselect().setVisible(true);
            }
        });
    }
