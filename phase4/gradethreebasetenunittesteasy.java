...
public class gradethreebasetenunittesteasy extends JFrame {
	...
	public gradethreebasetenunittesteasy() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					gradethreebasetenunittesteasy.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		headerTitle.setText("Grade 3 Base 10 Easy Unit Test");
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, gradethreebasetenunittesteasy.class.getResourceAsStream("Bungee-Regular.ttf"));
	       }
		catch(Exception e){}
		...
		correctAnswer.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(gradethreebasetenunittesteasy.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
					...
					buttonF.addMouseListener(new MouseAdapter() {
						...
						//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
							...
							percentage.setText(result+"%");
									...
									String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,3g3test) \n" +
											"VALUES (?,?)\n" +
											" on DUPLICATE key update 3g3test =?";
									try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(gradethreebasetenunittesteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(gradethreebasetenunittesteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(gradethreebasetenunittesteasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new gradethreebasetenunittesteasy().setVisible(true);
			}
		});
	}
