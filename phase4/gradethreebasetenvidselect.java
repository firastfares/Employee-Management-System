 ...
 * @author John Legg
 */
public class gradethreebasetenvidselect extends javax.swing.JFrame {


    public gradethreebasetenvidselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Videos On Third Grade Number and Operation Base Ten");//text of label
        ...
        rounding.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=VPdE5aOH52g"; // open this video on rounding to 10 or 100
        ...
        addsub1000.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=70Nn-X2ScoY"; // open this video on add sub within 1000
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        mutliplymutilple10.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=vlifeMSVh6I"; // open this video on multiply be multiples of ten
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gradethreebasetenvidselect().setVisible(true);
            }
        });
    }
