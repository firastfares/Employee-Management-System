...
public class gradethreebastenpracticetest extends JFrame {
	...
	public gradethreebastenpracticetest() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					gradethreebastenpracticetest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		hintButton.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton3.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton4.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton5.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		headerTitle.setText("Grade 3 Base10 Practice");
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, gradethreebastenpracticetest.class.getResourceAsStream("Bungee-Regular.ttf"));
	       }
		catch(Exception e){}
		...
		correctAnswer.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(gradethreebastenpracticetest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
		...
		int i = randomFill(100, 500);
		int j = randomFill(100, 500);
		int t = randomFill(1,10);
		int m = randomFill(1, 10)*10; //multiple of 10
		int k = randomFill(100, 500);
		int l = randomFill(100,500);
		int n = randomFill(100, 500);
		int p = randomFill(100, 500);
		int h = randomFill(1,99);
		int round = h;
		int q1 = ((round+5)/10)*10;
					...
					String[] questions = 	{"Round to the nearest 10:  \r\n" + h,
					...
					String[] hints = {"Remember 5 or more round up less than 5 round down",
							"Try to break the subtraction into place values starting with ones place borrowing a group of ten", "Try to multiply the tens place by "+ t,
							"Try and add by place value starting with ones carrying the one when needed", "Try to break the subtraction into place values"};
			      ...
			      //This if statements is used to sort out random number awkwardness for the subtraction problem.
					...
					if ((j) < i)
					{
						...
						answer[1] = (""+(i - (j)));
						hints[1] = "Try to break the subtraction into place values starting with ones place borrowing a group of ten";
					...
					if ((n) < p)
					{
						...
						answer[4] = (""+(p - (n)));
						hints[4] = "Try to break the subtraction into place values starting with ones place borrowing a group of ten";
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, "The answer is: " + answer[0]+". Remember 5 or more round up less than 5 round down"); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[2] + ". Next time, Try to multiply the tens place of " + m + " by "+ t );
			...
			submitAnswer4.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[3] + ". Next time, Try and add by place value starting with ones carrying the one when needed");
							submitAnswer4.setVisible(false);
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new MouseAdapter() {
						public void mousePressed(MouseEvent evt) {
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,3g3practice) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 3g3practice =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(gradethreebastenpracticetest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(gradethreebastenpracticetest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(gradethreebastenpracticetest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new gradethreebastenpracticetest().setVisible(true);
			}
		});
	}
