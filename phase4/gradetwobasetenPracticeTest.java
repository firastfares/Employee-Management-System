...
public class gradetwobasetenPracticeTest extends JFrame {
	...
	public gradetwobasetenPracticeTest() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					gradetwobasetenPracticeTest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		hintButton.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton3.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton4.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton5.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		headerTitle.setText("Grade 2 Base10 Practice");
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, gradetwobasetenPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
	       }
		catch(Exception e){}
		...
		correctAnswer.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(gradetwobasetenPracticeTest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
		...
		int i = randomFill(10, 100);
		int j = randomFill(10, 100);
		int t = 100;//add or sub 100
		int m = randomFill(100,900);// num 100 - 900
		int k = 10;//add or sub 10
		int l = randomFill(100,900);// num 100 - 900
		int n = randomFill(10, 100);
		int p = randomFill(10, 100);
		int h = randomFill(100,900);// num 100 - 900
		int q1 = h /100;
	         ...
	         Collections.shuffle(Arrays.asList(wordProblems));
				...
				String[] questions = 	{"How many hundreds are in? " + h,
											"Solve: " + (j) + " - " + i, "Solve: "+(m) + " + " + t,
						                    "Solve: "+(l) + " + " + k, "Solve: " + (n) + " - " + p};
				...
				String[] answer = {""+(q1), ""+((j)-i),""+((m)+t), "" + ((l)+k), ""+ ((n)-p)};
				...
				String[] hints = {"Remember that 706 has 7 hundreds, 0 tens, 6 ones!",
						"Try to think of the problem as removing " + i + " sticks from a pile of " + (j) + " sticks!", "Try to think of the problem as adding "+t,"marble into a marble jar with "+ (m+1) +" marbles",
						"Try to think of the problem as adding "+k,"legos into lego box with "+ (l) +" legos", "Try to think of the problem as removing " + p + " sticks from a pile of " + (n) + " sticks!","test complete"};
			      	 
			      //This if statements is used to sort out random number awkwardness for the subtraction problem.
			    
			      	//If (k+1) is less than j, the placements of those numbers will be reversed to prevent a negative answer, and all three arrays will be updated. 
			      	if ((j) < i)
			      	{
			      		questions[1] = "Subtract: " + i + " - " + (j);
			      		answer[1] = (""+(i - (j)));
			      		hints[1] = "Try to think of the problem as removing " + (j) + " sticks from a pile of " + i + " sticks!";
			      		
			      	}
					if ((n) < p)
					{
						questions[4] = "Subtract: " + p + " - " + (n);
						answer[4] = (""+(p - (n)));
						hints[4] = "Try to think of the problem as removing " + (n) + " sticks from a pile of " + p + " sticks!";
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, "The answer is " + answer[0] +" Next try and remember that 706 has 7 hundreds, 0 tens, 6 ones!"); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
				...
				public void mousePressed(MouseEvent evt) {
					...
					try{
			      		...
			      		else
						{
							...
							{
			      			clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[1] + ". Next time, try to think how many in the tens and ones place you are removing ");
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[2] + "Next time, try to remember that you are increasing the value in the hundreds place by one" );
			...
			submitAnswer4.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[3] + ". Next time, try to remember that you are increasing the value in the tens place by one" );
							submitAnswer4.setVisible(false);
				...
				public void mousePressed(MouseEvent evt) {
					try{
						...
						if (clicked == 3)
						{
							...
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[4] + ". Next time, try to think of how many in the tens and ones place you are removing ");
							submitAnswer5.setVisible(false);
							buttonF.setVisible(true);
						...
						public void mousePressed(MouseEvent evt) {
							...
							question2.addMouseListener(new MouseAdapter() {
								public void mousePressed(MouseEvent evt) {
									...
									try{
								           Font font = Font.createFont(Font.TRUETYPE_FONT, gradetwobasetenPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
								           //textArea5.setFont(font.deriveFont(Font.BOLD, 25f));
								       }
								       catch(Exception e){}
							...
							question4.addMouseListener(new MouseAdapter() {
								public void mousePressed(MouseEvent evt) {
									...
									try{
								           Font font = Font.createFont(Font.TRUETYPE_FONT, gradetwobasetenPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
								          // textArea5.setFont(font.deriveFont(Font.BOLD, 16f));
								       }
								       catch(Exception e){}
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,2g3practice) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update 2g3practice =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(gradetwobasetenPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(gradetwobasetenPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(gradetwobasetenPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new gradetwobasetenPracticeTest().setVisible(true);
			}
		});
	}
