...
public class kGeoPracticeTest extends JFrame {

	/**
	 * Creates new form kGeoPracticeTest
	 */
    ...
    int p1 = randomFill(1, 9);
    int p2 = randomFill (1, 9);
    int p3 = randomFill(1, 9);
    int p4 = randomFill(1, 9);
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 734);
		sidebar.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					kGeoPracticeTest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		hintButton.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton3.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton4.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		hintButton5.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/betterQuestionMark2.png")));
		...
		headerTitle.setBounds(353, 156, 713, 100);
		getContentPane().add(headerTitle);
		headerTitle.setText("Kindergarten Geo Practice Test");
		...
		try{
			 Font font = Font.createFont(Font.TRUETYPE_FONT, kGeoPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
		...
		correctAnswer.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(460, 175, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(kGeoPracticeTest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
		...
		ImageIcon triangle = new ImageIcon (getClass().getResource("Images/regulatTriangle3.png"));
	         ...
	         int p = randomFill(1, 9);
	         
	      
	         
	         ImageIcon[] test = {square, circle, triangle, rectangle, pentagon, hexagon, trapezoid, octagon};
	         ...
	         if (p == 1){imageHolder.setIcon(test[0]); m = "Square";}
	         
	         else if (p == 2) {imageHolder.setIcon(test[1]); m = "Circle";}
	         
	         else if (p == 3){imageHolder.setIcon(test[2]);m = "Triangle";}
	         
	         else if (p == 4){imageHolder.setIcon(test[3]);m = "Rectangle"; }
	         
	         else if (p == 5){imageHolder.setIcon(test[4]);m = "Pentagon";}
	         
	         else if (p == 6) {imageHolder.setIcon(test[5]); m = "Hexagon";}
	         
	         else if (p == 7){imageHolder.setIcon(test[6]); m = "Trapezoid";}

	         else if (p == 8){imageHolder.setIcon(test[7]);m = "octagon";}
	         
	         
	         
	         if (p1 == 1){imageHolder2.setIcon(test[0]); n = "Square";}
	         
	         else if (p1 == 2) {imageHolder2.setIcon(test[1]); n = "Circle";}
	         
	         else if (p1 == 3){imageHolder2.setIcon(test[2]);n = "Triangle";}
	         
	         else if (p1 == 4){imageHolder2.setIcon(test[3]);n = "Rectangle";}
	         
	         else if (p1 == 5){imageHolder2.setIcon(test[4]);n = "Pentagon";}
	         
	         else if (p1 == 6) {imageHolder2.setIcon(test[5]); n = "Hexagon";}
	         
	         else if (p1 == 7){imageHolder2.setIcon(test[6]); n = "Trapezoid";}

	         else if (p1 == 8){imageHolder2.setIcon(test[7]);n = "octagon";}
         ...
         if (p2 == 1){imageHolder3.setIcon(test[0]); o = "Square";}
	         
	         else if (p2 == 2) {imageHolder3.setIcon(test[1]); o = "Circle";}
	         
	         else if (p2 == 3){imageHolder3.setIcon(test[2]); o = "Triangle";}
	         
	         else if (p2 == 4){imageHolder3.setIcon(test[3]); o = "Rectangle"; }
	         
	         else if (p2 == 5){imageHolder3.setIcon(test[4]); o = "Pentagon";}
	         
	         else if (p2 == 6) {imageHolder3.setIcon(test[5]); o = "Hexagon";}
	         
	         else if (p2 == 7){imageHolder3.setIcon(test[6]); o = "Trapezoid";}

	         else if (p2 == 8){imageHolder3.setIcon(test[7]); o = "octagon";}
         
         //make new jLabel, variable for each
         if (p3 == 1){imageHolder4.setIcon(test[0]); y = "Square";}
	         
	         else if (p3 == 2) {imageHolder4.setIcon(test[1]); y = "Circle";}
	         
	         else if (p3 == 3){imageHolder4.setIcon(test[2]); y = "Triangle";}
	         
	         else if (p3 == 4){imageHolder4.setIcon(test[3]); y = "Rectangle"; }
	         
	         else if (p3 == 5){imageHolder4.setIcon(test[4]); y = "Pentagon";}
	         
	         else if (p3 == 6) {imageHolder4.setIcon(test[5]); y = "Hexagon";}
	         
	         else if (p3 == 7){imageHolder4.setIcon(test[6]); y = "Trapezoid";}

	         else if (p3 == 8){imageHolder4.setIcon(test[7]); y = "octagon";}
         
         
         
         if (p4 == 1){imageHolder4.setIcon(test[0]); z = "Square"; x = "4";}
         
         else if (p4 == 2) {imageHolder4.setIcon(test[1]); z = "Circle"; x = "0";}
         
         else if (p4 == 3){imageHolder4.setIcon(test[2]); z = "Triangle"; x = "3";}
         
         else if (p4 == 4){imageHolder4.setIcon(test[3]); z = "Rectangle"; x = "4"; }
         
         else if (p4 == 5){imageHolder4.setIcon(test[4]); z = "Pentagon"; x = "5";}
         
         else if (p4 == 6) {imageHolder4.setIcon(test[5]); z = "Hexagon"; x = "6";}
         
         else if (p4 == 7){imageHolder4.setIcon(test[6]); z = "Trapezoid";x = "4";}

         else if (p4 == 8){imageHolder4.setIcon(test[7]); z = "octagon"; x = "8";}
			      	...
			      	String[] questions = 	{"Identify this shape: ", 
			      			"Identify the rightmost shape: ",
			      			"Is the " + o + " on the left or right?",
			      					
			      			"How many sides does a " + z + " have?", "Are these shapes 2D or 3D?"}; 
			      	...
			      	String[] hints = {"Try counting the sides or imagining an object that has this shape in real life!", 
			      			"Try to recall what you've learned about the properties of different shapes!" , "Try to recall what you've learned about the properties of different shapes!" ,"Try drawing a picture and count the number of lines that you see on the shape!", "Try to recall what you've learned about about distinguishing flat shapes from solid shapes! "};
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, "This shape is a " + answer[0] + "! " + hints[0]); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
			...
			buttonA.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					while (p == p1)
					{
			         ...
			         if (p == 1){imageHolderDummy.setIcon(test[0]);}
			         
			         else if (p == 2) {imageHolderDummy.setIcon(test[1]);}
			         
			         else if (p == 3){imageHolderDummy.setIcon(test[2]);}
			         
			         else if (p == 4){imageHolderDummy.setIcon(test[3]);}
			         
			         else if (p == 5){imageHolderDummy.setIcon(test[4]);}
			         
			         else if (p == 6) {imageHolderDummy.setIcon(test[5]);}
			         
			         else if (p == 7){imageHolderDummy.setIcon(test[6]);}

			         else if (p == 8){imageHolderDummy.setIcon(test[7]);}
			         
				       imageHolder.setVisible(false);
					  imageHolderDummy.setVisible(true);
					  
					  imageHolder2.setVisible(true);
				...
				public void mousePressed(MouseEvent evt) {
					...
					try{
			      		...
			      		else
						{
							...
							{
			      			clicked = 0;
							JOptionPane.showMessageDialog(panel, "The shape on the right is a " + answer[1] +  "! Next time, try to recall what you've learned about the properties of different shapes!");
			...
			buttonB.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					while (p == p2)
					{
			         ...
			         if (p == 1){imageHolderDummy2.setIcon(test[0]);}
			         
			         else if (p == 2) {imageHolderDummy2.setIcon(test[1]);}
			         
			         else if (p == 3){imageHolderDummy2.setIcon(test[2]);}
			         
			         else if (p == 4){imageHolderDummy2.setIcon(test[3]);}
			         
			         else if (p == 5){imageHolderDummy2.setIcon(test[4]);}
			         
			         else if (p == 6) {imageHolderDummy2.setIcon(test[5]);}
			         
			         else if (p == 7){imageHolderDummy2.setIcon(test[6]);}

			         else if (p == 8){imageHolderDummy2.setIcon(test[7]);}
			         
				      imageHolderDummy.setVisible(false);   
					  imageHolderDummy2.setVisible(true);
					  imageHolder2.setVisible(false);
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The " + o + " is on the " + answer[2] + "!" + " " + hints[2]);
							submitAnswer3.setVisible(false);
							buttonC.setVisible(true);
			...
			submitAnswer4.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[3] + "! Try to recall properties of shapes!");
							submitAnswer4.setVisible(false);
			...
			buttonD.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					...
					while (p == p3)
					{
			         ...
			         if (p == 1){imageHolderDummy3.setIcon(test[0]);}
			         
			         else if (p == 2) {imageHolderDummy3.setIcon(test[1]);}
			         
			         else if (p == 3){imageHolderDummy3.setIcon(test[2]);}
			         
			         else if (p == 4){imageHolderDummy3.setIcon(test[3]);}
			         
			         else if (p == 5){imageHolderDummy3.setIcon(test[4]);}
			         
			         else if (p == 6) {imageHolderDummy3.setIcon(test[5]);}
			         
			         else if (p == 7){imageHolderDummy3.setIcon(test[6]);}
			         
			         else if (p == 8){imageHolderDummy3.setIcon(test[7]);}

			         
			         imageHolder.setVisible(false);
					  imageHolderDummy3.setVisible(true);
					  imageHolder3.setVisible(false);
					  imageHolder4.setVisible(true);
					  imageHolderDummy3.setBounds(365, 42, 170, 152);
				...
				public void mousePressed(MouseEvent evt) {
					try{
						...
						if (clicked == 3)
						{
							...
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[4] + "!" + " " + hints[4]);
							submitAnswer5.setVisible(false);
							buttonF.setVisible(true);
				...
				//Users can select 1 of the 5 question buttons to return to that question and view what their answer was
					resultsBut.addMouseListener(new MouseAdapter() {
						public void mousePressed(MouseEvent evt) {
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,k1practice) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update k1practice =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(kGeoPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(kGeoPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(kGeoPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new kGeoPracticeTest().setVisible(true);
			}
		});
	}
