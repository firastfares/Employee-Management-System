 ...
 * @author John Legg
 */
public class kbasetenvidselect extends javax.swing.JFrame {


    public kbasetenvidselect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Videos On Kindergarten Number and Operation Base Ten");//text of label
        ...
        compdecomp.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=kIPjwstGqPM"; // open this video on composing and decomposing numbers
        ...
        compdecom11to19.setText("Compose & Decompose Numbers");//text
        ...
        compdecom11to19.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=_7yZ-FIBj-g"; // open this video on composition and decomposition 11-19
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
        ...
        placevalsong.setText("Place value song ");//button text
        ...
        placevalsong.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) { //when mouse is pressed on this button open link in browser
                try {
                    String url = "https://www.youtube.com/watch?v=uedvwH6Ay18"; // open this video on place value song
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create(url));
                } catch (java.io.IOException e) {
                    System.out.println(e.getMessage());
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new kbasetenvidselect().setVisible(true);
            }
        });
    }
