...
public class kinderbasetenPracticeTest extends JFrame {
	...
	public kinderbasetenPracticeTest() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					kinderbasetenPracticeTest.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		hintButton.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		hintButton.setContentAreaFilled(false);
		hintButton.setBorderPainted(false);
		getContentPane().add(hintButton);
		hintButton2.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton2.setVisible(false);
		hintButton2.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton3.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton3.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton4.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton4.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		hintButton5.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (16).png")));
		hintButton5.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/Webp.net-resizeimage (18).png")));
		...
		headerTitle.setText("Kindergarten Base10 Practice");
		headerTitle.setFont(new Font("Roboto", Font.BOLD, 25));
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, kinderbasetenPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
	       }
		catch(Exception e){}
		...
		try{
			 Font font = Font.createFont(Font.TRUETYPE_FONT, kinderbasetenPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
	           ...
	           question4.setFont(font.deriveFont(Font.BOLD, 25f));
	           panel.add(question4);
		...
		correctAnswer.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(kinderbasetenPracticeTest.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
			 ...
			 int a = randomFill(1, 10);
			 int b = randomFill(1, 10);

			 int c = randomFill(1, 10);
			 int d = randomFill(1, 10);

			 int e = randomFill(1, 10);
			 int f = randomFill(1, 10);

			 int g = randomFill(1, 10);
			 int h = randomFill(1, 10);
			      	...
			      	String[] questions = 	{"What number is this ? " + (j) + " + " + i,
							"What number is this ? " + (a) + " + " + b,"What number is this ? " + (c) + " + " + d,
							"What number is this ? " + (e) + " + " + f, "What number is this ? " + (g) + " + " + h};
			      	...
			      	String[] answer = {""+((j)+i), ""+((a)+b),""+((c)+d), "" + ((e)+f), ""+ ((g)+h)};
			      	...
			      	String[] hints = {"Try and see what "+ j + "one and " +i +"ones form.","Try and see what "+ a + "ones and " + b +"ones form.","Try and see what "+ c + "ones and " + d +"ones form.",
							"Try and see what "+ e + "ones and " + f +"ones form.","Try and see what "+ g + "ones and " + h +"ones form."};
					...
					try{
			      		...
			      		else //if the user is incorrect
						{
							...
							if (clicked == 3) 
							{
								...
								JOptionPane.showMessageDialog(panel, " The answer is, "+ answer[0] + " try and see what "+ j + "ones and " +i +"ones form."); //Edit this dialog box to edit the auto hint. Again, you don't have to use the random number variables if you don't want to and can make the hint whatever you want.
								textAnswer.setEnabled(false); //Statement to disable the text field to prevent multiple answers from being submitted
				...
				public void mousePressed(MouseEvent evt) {
					...
					try{
			      		...
			      		else
						{
							...
							{
			      			clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[1] + ". Next time, try and see what "+ a + "ones and " +b +"ones form.");
			...
			submitAnswer3.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is "+ answer[2]+ ". Next time try and see what "+ c + "ones and " + d +"ones form."  );
			...
			submitAnswer4.addMouseListener(new MouseAdapter() {
				public void mousePressed(MouseEvent evt) {
					try{
						...
						{
							clicked = 0;
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[3] + ". Next time, try and see what "+ e + "ones and " + f +"ones form."  );
							submitAnswer4.setVisible(false);
				...
				public void mousePressed(MouseEvent evt) {
					try{
						...
						if (clicked == 3)
						{
							...
							JOptionPane.showMessageDialog(panel, "The answer is " + answer[4] + ". Next time, try and see what "+ g + "ones and " + h +"ones form.");
							submitAnswer5.setVisible(false);
							buttonF.setVisible(true);
						...
						public void mousePressed(MouseEvent evt) {
							...
							question1.addMouseListener(new MouseAdapter() {
								public void mousePressed(MouseEvent evt) {
									...
									try{
								           Font font = Font.createFont(Font.TRUETYPE_FONT, kinderbasetenPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
								           //xtArea5.setFont(font.deriveFont(Font.BOLD, 25f));
								       }
								       catch(Exception e){}
							...
							question4.addMouseListener(new MouseAdapter() {
								public void mousePressed(MouseEvent evt) {
									...
									try{
								           Font font = Font.createFont(Font.TRUETYPE_FONT, kinderbasetenPracticeTest.class.getResourceAsStream("Bungee-Regular.ttf"));
								           //.setFont(font.deriveFont(Font.BOLD, 25f));
								       }
								       catch(Exception e){}
							...
							String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,k3practice) \n" +
									"VALUES (?,?)\n" +
									" on DUPLICATE key update k3practice =?";
							try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(kinderbasetenPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(kinderbasetenPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(kinderbasetenPracticeTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new kinderbasetenPracticeTest().setVisible(true);
			}
		});
	}
