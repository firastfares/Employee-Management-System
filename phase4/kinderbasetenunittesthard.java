...
public class kinderbasetenunittesthard extends JFrame {
	...
	public kinderbasetenunittesthard() {
		initComponents();
	...
	private void initComponents() {
		...
		header.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/opacitymaybe.png")));
		numcrunch = new JLabel();
		numcrunch.setBounds(20, 0, 225, 60);
		sidebar = new JLabel();
		sidebar.setBounds(0, 0, 260, 723);
		sidebar.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/opacitymaybe2.png")));
		back = new JLabel();
		...
		try {
			Font font = Font.createFont(Font.TRUETYPE_FONT,
					kinderbasetenunittesthard.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
		...
		headerTitle.setBounds(356, 156, 713, 100);
		getContentPane().add(headerTitle);
		headerTitle.setText("Kindergarten Base 10 Unit Test - Advanced");
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, kinderbasetenunittesthard.class.getResourceAsStream("Bungee-Regular.ttf"));
	       }
		catch(Exception e){}
		...
		correctAnswer.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/correctCheck5.png")));
		correctAnswer.setVisible(false);
		correctAnswer.setBounds(472, 135, 100, 106);
		panel.add(correctAnswer);

		
		incorrectAnswer.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/incorrectX.png")));
		...
		buttonA.setPressedIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonA.setOpaque(false);
		buttonA.setRolloverIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonA.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrow.png")));
		...
		buttonB.setPressedIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonB.setOpaque(false);
		buttonB.setFocusable(false);
		buttonB.setRolloverIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonB.setBorder(null);
		buttonB.setBorderPainted(false);
		buttonB.setContentAreaFilled(false);
		buttonB.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrow.png")));
		buttonB.setVisible(false);
		buttonB.setBounds(554, 282, 136, 87);
		panel.add(buttonB);

		
		buttonC.setPressedIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonC.setOpaque(false);
		buttonC.setRolloverIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonC.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrow.png")));
		...
		buttonD.setPressedIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonD.setRolloverIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonD.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrow.png")));
		...
		buttonE.setPressedIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonE.setRolloverIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowHover.png")));
		buttonE.setOpaque(false);
		buttonE.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrow.png")));
		...
		panel.add(buttonE);
		buttonF.setRolloverIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/goldenArrowHover (2).png")));

		buttonF.setOpaque(false);
		buttonF.setIcon(new ImageIcon(kinderbasetenunittesthard.class.getResource("Images/arrowMoveOn.png")));
...
//Kind of a crude implementation but it works and it's flexible
	...
	public void shortAnswerTestGenerator()
	{
	         ...
	         int i = randomFill(1, 19);
	         int j = randomFill(1, 19);

			 int a = randomFill(1, 19);
			 int b = randomFill(1, 19);

			 int c = randomFill(1, 19);
			 int d = randomFill(1, 19);

			 int e = randomFill(1, 19);
			 int f = randomFill(1, 19);

			 int g = randomFill(1, 19);
			 int h = randomFill(1, 19);
					...
					beginTest.addMouseListener(new MouseAdapter() {
						...
						buttonF.addMouseListener(new MouseAdapter() {
							...
							percentage.setText(result+"%");
										...
										String query="INSERT INTO numbercruncher.practice_test_grade(student_uname,k3testhard) \n" +
												"VALUES (?,?)\n" +
												" on DUPLICATE key update k3testhard =?";
										try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(kinderbasetenunittesthard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (InstantiationException ex) {
			java.util.logging.Logger.getLogger(kinderbasetenunittesthard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		} catch (IllegalAccessException ex) {
			java.util.logging.Logger.getLogger(kinderbasetenunittesthard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new kinderbasetenunittesthard().setVisible(true);
			}
		});
	}
