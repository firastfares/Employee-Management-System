 ...
 * @author John Legg
 */
public class testselectunittest1baseten extends JFrame {


    public testselectunittest1baseten() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("1st Grade Base Ten Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open  test
                ...
                gradeonebasetenunittesteasy gradeonebasetenunittesteasy = new gradeonebasetenunittesteasy();
                gradeonebasetenunittesteasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                gradeonebasetenunittesthard gradeonebasetenunittesthard = new gradeonebasetenunittesthard();
                gradeonebasetenunittesthard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest1baseten().setVisible(true);
            }
        });
    }
