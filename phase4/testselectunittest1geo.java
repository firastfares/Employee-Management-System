 ...
 * @author John Legg
 */
public class testselectunittest1geo extends JFrame {


    public testselectunittest1geo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("1st Grade Geometry Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade1GeoUnitTestEasy grade1GeoUnitTestEasy = new grade1GeoUnitTestEasy();
                grade1GeoUnitTestEasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade1GeoUnitTestHard grade1GeoUnitTestHard = new grade1GeoUnitTestHard();
                grade1GeoUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest1geo().setVisible(true);
            }
        });
    }
