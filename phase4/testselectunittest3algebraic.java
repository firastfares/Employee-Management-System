 ...
 * @author John Legg
 */
public class testselectunittest3algebraic extends JFrame {


    public testselectunittest3algebraic() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("3rd Grade Algebraic Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open  test
                ...
                grade3OATUnitTestEasy grade3OATUnitTestEasy = new grade3OATUnitTestEasy();
                grade3OATUnitTestEasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                grade3OATUnitTestHard grade3OATUnitTestHard  = new grade3OATUnitTestHard();
                grade3OATUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest3algebraic().setVisible(true);
            }
        });
    }
