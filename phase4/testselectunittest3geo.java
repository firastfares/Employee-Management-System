 ...
 * @author John Legg
 */
public class testselectunittest3geo extends JFrame {


    public testselectunittest3geo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("3rd Grade Geometry Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade3GeoUnitTest grade3GeoUnitTest = new grade3GeoUnitTest();
                grade3GeoUnitTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade3GeoUnitTestHard grade3GeoUnitTestHard = new grade3GeoUnitTestHard();
                grade3GeoUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest3geo().setVisible(true);
            }
        });
    }
