 ...
 * @author John Legg
 */
public class testselectunittest4algebraic extends JFrame {


    public testselectunittest4algebraic() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("4th Grade Algebraic Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                grade4OATUnitTestEasy grade4OATUnitTestEasy = new grade4OATUnitTestEasy();
                grade4OATUnitTestEasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open  test
                ...
                grade4OATUnitTestHard grade4OATUnitTestHard  = new grade4OATUnitTestHard();
                grade4OATUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittest4algebraic().setVisible(true);
            }
        });
    }
