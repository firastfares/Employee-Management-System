 ...
 * @author John Legg
 */
public class testselectunittestkalgebraic extends JFrame {


    public testselectunittestkalgebraic() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Kindergarten Algebraic Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                kOATUnitTestEasy kOATUnitTestEasy  = new kOATUnitTestEasy();
                kOATUnitTestEasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                kOATUnitTestHard kOATUnitTestHard  = new kOATUnitTestHard();
                kOATUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittestkalgebraic().setVisible(true);
            }
        });
    }
