 ...
 * @author John Legg
 */
public class testselectunittestkbaseten extends JFrame {


    public testselectunittestkbaseten() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Kindergarten Base Ten Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                kinderbasetenunittesteasy kinderbasetenunittesteasy = new kinderbasetenunittesteasy();
                kinderbasetenunittesteasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open test
                ...
                kinderbasetenunittesthard kinderbasetenunittesthard = new kinderbasetenunittesthard();
                kinderbasetenunittesthard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittestkbaseten().setVisible(true);
            }
        });
    }
