 ...
 * @author John Legg
 */
public class testselectunittestkgeo extends JFrame {


    public testselectunittestkgeo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Kindergarten Geometry Tests");//text
        ...
        easy.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                kGeoUnitTestEasy kGeoUnitTestEasy = new kGeoUnitTestEasy();
                kGeoUnitTestEasy.setVisible(true);
                setVisible(false);//close unit select
        ...
        hard.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                kGeoUnitTestHard kGeoUnitTestHard = new kGeoUnitTestHard();
                kGeoUnitTestHard.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testselectunittestkgeo().setVisible(true);
            }
        });
    }
