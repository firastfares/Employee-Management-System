...
public class unitTest2 extends JFrame implements ActionListener {
    ...
    public unitTest2() {
		...
		try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, unitTest2.class.getResourceAsStream("Bungee-Regular.ttf"));
		...
		lblNewLabel_1.setBounds(415, 153, 240, 137);
    ...
    private void initComponents() {
        ...
        try{
	           Font font = Font.createFont(Font.TRUETYPE_FONT, unitTest2.class.getResourceAsStream("MPLUSRounded1c-Black.ttf"));
	...
	private void returnButMouseClicked(MouseEvent evt) {
	...
	public void nextQuestion() {
    	...
    	buttonD.setIcon(null);
    		...
    		if (index != 2 && index < 5) {
    			...
    			{
    				triangle = new ImageIcon(getClass().getResource("Images/arearec2.png"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitTest2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
