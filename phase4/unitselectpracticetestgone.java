 ...
 * @author John Legg
 */
public class unitselectpracticetestgone extends JFrame {


    public unitselectpracticetestgone() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("First Grade Select a Unit Practice");//text
        ...
        geometry.setIcon(new ImageIcon(getClass().getResource("Images/1stgradegeometry.png")));//button icon
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade1GeoPracticeTest grade1GeoPracticeTest = new grade1GeoPracticeTest();
                grade1GeoPracticeTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade1OATPracticeTest grade1OATPracticeTest = new grade1OATPracticeTest();
                grade1OATPracticeTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                gradeonebasetenPracticeTest gradeonebasetenPracticeTest = new gradeonebasetenPracticeTest();
                gradeonebasetenPracticeTest.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectpracticetestgone().setVisible(true);
            }
        });
    }
