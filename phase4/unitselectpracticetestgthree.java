 ...
 * @author John Legg
 */
public class unitselectpracticetestgthree extends JFrame {


    public unitselectpracticetestgthree() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Third Grade Select a Unit Practice");//text
        ...
        geometry.setIcon(new ImageIcon(getClass().getResource("Images/3rdgradegeometry2.png")));//button icon
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                try {
                ...
                grade3GeoPracticeTest grade3GeoPracticeTest = new grade3GeoPracticeTest();
                grade3GeoPracticeTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.setIcon(new ImageIcon(getClass().getResource("Images/3rdgradealgebraic.png")));//button icon
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                grade3OATPracticeTest grade3OATPracticeTest = new grade3OATPracticeTest();
                grade3OATPracticeTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.setIcon(new ImageIcon(getClass().getResource("Images/3rdgradebaseten.jpg")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                gradethreebastenpracticetest gradethreebastenpracticetest = new gradethreebastenpracticetest();
                gradethreebastenpracticetest.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectpracticetestgthree().setVisible(true);
            }
        });
    }
