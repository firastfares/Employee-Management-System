 ...
 * @author John Legg
 */
public class unitselectpracticetestk extends JFrame {


    public unitselectpracticetestk() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Kindergarten Select a Unit Practice");//text
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                kGeoPracticeTest kGeoPracticeTest = new kGeoPracticeTest();
                kGeoPracticeTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                kOATPracticeTest kOATPracticeTest = new kOATPracticeTest();
                kOATPracticeTest.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open practice test
                ...
                kinderbasetenPracticeTest kinderbasetenPracticeTest = new kinderbasetenPracticeTest();
                kinderbasetenPracticeTest.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectpracticetestk().setVisible(true);
            }
        });
    }
