 ...
 * @author John Legg
 */
public class unitselectrecordingsgone extends JFrame {


    public unitselectrecordingsgone() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Grade 1 Select a Unit to Watch ");//text
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradeonegeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradeonegeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradeonegeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradeonegeometryrecselect gradeonegeometryrecselect = new gradeonegeometryrecselect();
                gradeonegeometryrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                ...
                gradeonealgebraicrecselect gradeonealgebraicrecselect = new gradeonealgebraicrecselect();
                gradeonealgebraicrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                ...
                gradeonbasetenrecselect gradeonbasetenrecselect = new gradeonbasetenrecselect();
                gradeonbasetenrecselect.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitselectrecordingsgone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsgone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsgone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectrecordingsgone().setVisible(true);
            }
        });
    }
