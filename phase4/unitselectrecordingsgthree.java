 ...
 * @author John Legg
 */
public class unitselectrecordingsgthree extends JFrame {


    public unitselectrecordingsgthree() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Grade 3 Select a Unit to Watch");//text
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradethreegeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradethreegeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradethreegeometryrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradethreegeometryrecselect gradethreegeometryrecselect = new gradethreegeometryrecselect();
                gradethreegeometryrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradethreealgebraicrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradethreealgebraicrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradethreealgebraicrecselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradethreealgebraicrecselect gradethreealgebraicrecselect = new gradethreealgebraicrecselect();
                gradethreealgebraicrecselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open recording
                ...
                gradethreebasetenrecselect gradethreebasetenrecselect = new gradethreebasetenrecselect();
                gradethreebasetenrecselect.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitselectrecordingsgthree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsgthree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(unitselectrecordingsgthree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectrecordingsgthree().setVisible(true);
            }
        });
    }
