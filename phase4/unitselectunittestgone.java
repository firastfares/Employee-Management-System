 ...
 * @author John Legg
 */
public class unitselectunittestgone extends JFrame {


    public unitselectunittestgone() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("First Grade Select a Unit Test");//text
        ...
        geometry.setIcon(new ImageIcon(getClass().getResource("Images/1stgradegeometry2.png")));//button icon
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest1geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest1geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest1geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest1geo testselectunittest1geo = new testselectunittest1geo();
                testselectunittest1geo.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.setIcon(new ImageIcon(getClass().getResource("Images/2ndgradebaseten3.png")));//button icon
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest1algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest1algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest1algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest1algebraic testselectunittest1algebraic = new testselectunittest1algebraic();
                testselectunittest1algebraic.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.setIcon(new ImageIcon(getClass().getResource("Images/1stgradebaseten.png")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest1baseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest1baseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest1baseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest1baseten testselectunittest1baseten = new testselectunittest1baseten();
                testselectunittest1baseten.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectunittestgone().setVisible(true);
            }
        });
    }
