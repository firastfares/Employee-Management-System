 ...
 * @author John Legg
 */
public class unitselectunittestgthree extends JFrame {


    public unitselectunittestgthree() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Grade 3 Select a Unit Test");//text
        ...
        geometry.setIcon(new ImageIcon(getClass().getResource("Images/moreproblemsgeo2.png")));//button icon
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest3geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest3geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest3geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest3geo testselectunittest3geo = new testselectunittest3geo();
                testselectunittest3geo.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest3algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest3algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest3algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest3algebraic testselectunittest3algebraic= new testselectunittest3algebraic();
                testselectunittest3algebraic.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.setIcon(new ImageIcon(getClass().getResource("Images/3rdgradebaseten3.jpg")));//button icon
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest3baseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest3baseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest3baseten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest3baseten testselectunittest3baseten = new testselectunittest3baseten();
                testselectunittest3baseten.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectunittestgthree().setVisible(true);
            }
        });
    }
