 ...
 * @author John Legg
 */
public class unitselectunittestgtwo extends JFrame {


    public unitselectunittestgtwo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title.setText("Second Grade Select a Unit Test");//text
        ...
        geometry.setIcon(new ImageIcon(getClass().getResource("Images/moreproblemsgeo.png")));//button icon
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest2geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest2geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest2geo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest2geo testselectunittest2geo = new testselectunittest2geo();
                testselectunittest2geo.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                try {
                    ...
                    java.util.logging.Logger.getLogger(testselectunittest2algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest2algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(testselectunittest2algebraic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                testselectunittest2algebraic testselectunittest2algebraic = new testselectunittest2algebraic();
                testselectunittest2algebraic.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open unit test select
                ...
                testselectunittest2baseten testselectunittest2baseten = new testselectunittest2baseten();
                testselectunittest2baseten.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectunittestgtwo().setVisible(true);
            }
        });
    }
