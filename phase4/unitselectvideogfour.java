 ...
 * @author John Legg
 */
public class unitselectvideogfour extends JFrame {


    public unitselectvideogfour() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradefourgeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradefourgeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradefourgeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradefourgeometryvidselect gradefourgeometryvidselect = new gradefourgeometryvidselect();
                gradefourgeometryvidselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                ...
                gradefouralgebraicvidselect gradefouralgebraicvidselect = new gradefouralgebraicvidselect();
                gradefouralgebraicvidselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                ...
                gradefourbasetenvidselect gradefourbasetenvidselect = new gradefourbasetenvidselect();
                gradefourbasetenvidselect.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitselectvideogfour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(unitselectvideogfour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(unitselectvideogfour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectvideogfour().setVisible(true);
            }
        });
    }
