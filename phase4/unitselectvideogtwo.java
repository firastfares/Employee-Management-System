 ...
 * @author John Legg
 */
public class unitselectvideogtwo extends JFrame {


    public unitselectvideogtwo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        geometry.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradetwogeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradetwogeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradetwogeometryvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradetwogeometryvidselect gradetwogeometryvidselect = new gradetwogeometryvidselect();
                gradetwogeometryvidselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        Algebraic.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                try {
                    ...
                    java.util.logging.Logger.getLogger(gradetwoalgebraicvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (InstantiationException ex) {
                    java.util.logging.Logger.getLogger(gradetwoalgebraicvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                } catch (IllegalAccessException ex) {
                    java.util.logging.Logger.getLogger(gradetwoalgebraicvidselect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                ...
                gradetwoalgebraicvidselect gradetwoalgebraicvidselect = new gradetwoalgebraicvidselect();
                gradetwoalgebraicvidselect.setVisible(true);
                setVisible(false);//close unit select
        ...
        baseten.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {//open video
                ...
                gradetwobasetenvidselect gradetwobasetenvidselect = new gradetwobasetenvidselect();
                gradetwobasetenvidselect.setVisible(true);
                setVisible(false);//close unit select
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(unitselectvideogtwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(unitselectvideogtwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(unitselectvideogtwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                new unitselectvideogtwo().setVisible(true);
            }
        });
    }
