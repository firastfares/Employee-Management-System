...
public class tutorialtemplate extends JFrame implements ActionListener {
  ...
  public void nextQuestion() {
	...
	else
	{
		...
		returnBut.setText("Click here to return to the difficulty selector page!");
    ...
    private void homebutActionPerformed(ActionEvent evt) {//GEN-FIRST:event_profilebutActionPerformed
